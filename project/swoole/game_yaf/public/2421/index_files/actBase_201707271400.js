    ...
    1: [function (t, e, n) {
        ...
        !function (t) {
            var e = {
                ...
                }, performance: function (e, n) {
                    if (window.performance) {
                        var i = window.performance.timing, r = e || 0;
                        if (i.loadEventEnd) {
                            var o = i.domComplete - i.domInteractive,
                                a = i.domContentLoadedEventEnd - i.navigationStart,
                                s = i.loadEventEnd - i.navigationStart,
                                c = window.dbStyleConfigEnd ? window.dbStyleConfigEnd - i.navigationStart : "",
                                u = window.dbStyleConfigEnd - window.dbStyleConfigStart,
                                l = "/statistics/activityPagePerf?hdType=" + CFG.actType + "&oaId=" + CFG.activityId + "&domComplete=" + o + "&domLoaded=" + a + "&onload=" + s + "&white=" + c + "&dbStyle=" + u;
                            n && (l += "&ip=" + n.ip + "&reqId=" + n.reqId);
                            var f = (new Date).getTime(), d = {
                                url: l, type: "post", data: {}, dataType: "json", success: function () {
                                }, error: function () {
                                }
                            };
                            d.data.timestamp = f, window.xhr = t.ajax(d)
                        } else r < 10 && setTimeout(function () {
                    ...
                    init: function (n) {
                        t(".buoy").length || (CFG.isShowBuoy || n) && e.ajax(function (e) {
                            if (e) {
                                ...
                                n.append(e.styleCode), t("body").append(n), setTimeout(function () {
        ...
        !function () {
            ...
            var n = navigator.userAgent.indexOf("Windows Phone") >= 0,
                ...
                a = o && /OS 4_\d(_\d)?/.test(navigator.userAgent), s = o && /OS [6-7]_\d/.test(navigator.userAgent),
        ...
        !function (t, e) {
            ...
            var l = new RegExp("\\.css|.less"), f = e.head || e.getElementsByTagName("head")[0],
                d = +navigator.userAgent.replace(/.*(?:AppleWebKit|AndroidWebKit)\/?(\d+).*/i, "$1") < 536, p = {
                    async: function (t, n) {
                        u(e, function () {
                            c(t, {}, n)
                        })
        ...
        var i = "function" == typeof Symbol && "symbol" === _typeof2(Symbol.iterator) ? function (t) {
            ...
            function t(t) {
                return null == t ? t + "" : G[H.call(t)] || "object"
            }
            ...
            var E, C, S, k, T, j, N = [], A = N.slice, O = N.filter, L = window.document, P = {}, _ = {}, I = {
                    "column-count": 1,
                    columns: 1,
                    "font-weight": 1,
                    "line-height": 1,
                ...
                M = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, q = /^(?:body|html)$/i,
                $ = /([A-Z])/g, R = ["val", "css", "html", "text", "data", "width", "height", "offset"],
                B = ["after", "prepend", "before", "append"], z = L.createElement("table"), Z = L.createElement("tr"),
                W = {
                    ...
                    th: Z,
                    "*": L.createElement("div")
                }, U = /complete|loaded|interactive/, X = /^[\w-]*$/, G = {}, H = G.toString, V = {},
                Y = L.createElement("div"), J = {
                    tabindex: "tabIndex",
                    readonly: "readOnly",
                    "for": "htmlFor",
                    "class": "className",
            ...
            return V.matches = function (t, e) {
                ...
                return o && (r = Y).appendChild(t), i = ~V.qsa(r, e).indexOf(t), o && Y.removeChild(t), i
            }, T = function (t) {
                ...
                var i, r, o;
                return F.test(t) && (i = S(L.createElement(RegExp.$1))), i || (t.replace && (t = t.replace(M, "<$1></$2>")), e === E && (e = D.test(t) && RegExp.$1), e in W || (e = "*"), o = W[e], o.innerHTML = "" + t, i = S.each(A.call(o.childNodes), function () {
                    o.removeChild(this)
                ...
                offset: function (t) {
                    if (t) return this.each(function (e) {
                        var n = S(this), i = y(this, t, e, n.offset()), r = n.offsetParent().offset(),
                ...
                position: function () {
                    if (this.length) {
                        var t = this[0], e = this.offsetParent(), n = this.offset(),
                            i = q.test(e[0].nodeName) ? {top: 0, left: 0} : e.offset();
        ...
        window.Zepto = r, void 0 === window.$ && (window.$ = r), function (t) {
            ...
            var m, v, y = 0, g = window.document, b = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,
                w = /^(?:text|application)\/javascript/i, x = /^(?:text|application)\/xml/i, E = "application/json",
                C = "text/html", S = /^\s*$/;
            t.active = 0, t.ajaxJSONP = function (e, n) {
                if (!("type" in e)) return t.ajax(e);
                var i, r, c = e.jsonpCallback, u = (t.isFunction(c) ? c() : c) || "jsonp" + ++y,
                    l = g.createElement("script"), f = window[u], d = function (e) {
                ...
                // n.url = n.url.split('?');
                // n.url = n.url[0];
                // if(/^\/activity\//.test(n.url)) {
                //     n.url = n.url.replace(/^\/activity\//, '')
                // }
                // console.log(n.url)
            ...
            var f, d = 1, p = Array.prototype.slice, h = t.isFunction, m = function (t) {
                ...
                }, v = {}, y = {}, g = "onfocusin" in window, b = {focus: "focusin", blur: "focusout"},
