!function (n, e, t) {
    ...
    1: [function (n, e, t) {
        ...
        function r(n, e, t, r) {
            ...
            var i = p[n][e];
            return i || (i = p[n][e] = {params: t || {}}), i.metrics = o(r, i.metrics), i
        }
        ...
        function o(n, e) {
            var t = e || n;
            l.store("cm", "finished", {name: "finished"}, {time: t - h.offset}), i(n, {
                name: "finished",
                start: t,
                origin: "nr"
        ...
        function a(n, e, t, r, o, i, a) {
            if (e = window.encodeURIComponent(e), g += 1, h.info.beacon) {
                ...
                s += "?a=" + h.info.applicationID + "&", s += "t=" + e + "&", s += "qt=" + ~~t + "&", s += "ap=" + ~~r + "&", s += "be=" + ~~o + "&", s += "dc=" + ~~i + "&", s += "fe=" + ~~a + "&", s += "c=" + g, m.img(s)
            }
        }
        ...
        var f = n(13), c = n(8), l = n(2), p = n(15), m = n(19), d = n(30), h = n("loader"), v = n("handle"), g = 0;
        ...
        var u = n(30), f = n(18), c = {"%2C": ",", "%3A": ":", "%2F": "/", "%40": "@", "%24": "$", "%3B": ";"},
            l = u(c, function (n) {
                return n
        ...
        function u(n, e, t, r) {
            ...
            switch (e) {
                case"jserrors":
                    ...
                    break;
                default:
                    if (r.needResponse) a = !0, i = w.xhr; else if (r.unload) a = q, i = q ? w.beacon : w.img; else if (R) a = !0, i = w.xhr; else {
        ...
        var d = n(15), h = n(30), v = n(12), g = n(6), y = n(18), w = n(19), x = n(32), b = n(2), k = n(17),
            j = n("loader"), E = n(4), S = "1016.8b58850", A = "NREUM.setToken", T = {}, q = !!navigator.sendBeacon;
        n(9);
       var R = j.xhrWrappable && (j.ieVersion > 9 || 0 === j.ieVersion);
        e.exports = {sendRUM: d(r), sendFinal: o, pingErrors: f, sendX: a, on: l, xhrUsable: R}
    }, {}], 9: [function (n, e, t) {
        ...
        function r(n) {
            f.sendFinal(p, !1), a.navCookie && (document.cookie = "NREUM=s=" + Number(new Date) + "&r=" + o(document.location.href) + "&p=" + o(document.referrer) + "; path=/")
        }

        var o = n(14), i = n(1), a = n(16), s = n(17), u = n(15), f = n(8), c = n(13), l = n(7), p = n("loader"),
            m = n(29), d = n(5);
        n(3);
        ...
        var v = u(r);
        !m || navigator.sendBeacon ? i("pagehide", v) : i("beforeunload", v), i("unload", v), c("mark", s.mark, "api"), s.mark("done"), d("api"), h && f.sendRUM(p)
    }, {}], 11: [function (n, e, t) {
        e.exports = function (n, e) {
        ...
        function r(n, e) {
            ...
            return e.of = t, i(t, t, e, "n"), i(n[u + a], t, e, "u"), i(n[f + a], t, e, "r"), i(n[u + s], t, e, "ue"), i(n[f + s], t, e, "re"), i(n["fetch" + a], t, e, "f"), i(n[c + a], t, e, "dn"), i(n[c + s], t, e, "dne"), i(n["c" + l + a], t, e, "c"), i(n["secureC" + l + "ion" + a], t, e, "s"), i(n["c" + l + s], t, e, "ce"), i(n[p + a], t, e, "rq"), i(n[m + a], t, e, "rp"), i(n[m + s], t, e, "rpe"), i(n.domLoading, t, e, "dl"), i(n.domInteractive, t, e, "di"), i(n[h + a], t, e, "ds"), i(n[h + s], t, e, "de"), i(n.domComplete, t, e, "dc"), i(n[d + a], t, e, "l"), i(n[d + s], t, e, "le"), e
        }
        ...
        var a = "Start", s = "End", u = "unloadEvent", f = "redirect", c = "domainLookup", l = "onnect", p = "request",
            m = "response", d = "loadEvent", h = "domContentLoadedEvent", v = [];
        ...
        var a = n(14), s = n(17), u = n("loader"), f = n(29);
        ...
        function p(n) {
            ...
            var t, r, o, i = /^\s*Line (\d+) of linked script ((?:file|http|https)\S+)(?:: in function (\S+))?\s*$/i,
                ...
                s = /^\s*Line (\d+) of function script\s*$/i, u = [], l = [],
                p = document.getElementsByTagName("script"), m = [], v = !1;
            for (r in p) h.call(p, r) && !p[r].src && m.push(p[r]);
            for (r = 2, o = e.length; r < o; r += 2) {
                ...
                g && (c(g.func) ? v = !0 : l.push(e[r]), v || u.push(g))
            }
            return u.length ? {
                mode: "multiline",
                name: n.name || f(n),
        ...
        var m = n(32), d = n(22), h = Object.prototype.hasOwnProperty, v = !1, g = /function (.+?)\s*\(/,
        ...
        function s(n, e, t) {
            if (e = e || (new Date).getTime(), t || !m.onerror || !m.onerror(n)) {
                var o = a(l(n)), s = i(o),
                    f = {stackHash: p(s), exceptionClass: o.name, request_uri: window.location.pathname};
                o.message && (f.message = "" + o.message), h[f.stackHash] ? f.browser_stack_hash = p(o.stackString) : (h[f.stackHash] = !0, f.stack_trace = o.stackString);
                var c = r(f);
                v[c] || (f.pageview = 1, v[c] = !0), u.store(t ? "ierr" : "err", c, f, {time: e - m.offset})
            }
        }

        var u = n(2), f = n(20), c = n(4), l = n(21), p = n(24), m = n("loader"), d = n("ee"), h = {}, v = {},
            g = n(13), y = n(8), w = n(11), x = n(18);
        if (n(16), m.features.err) {
            var b = !1;
            y.on("jserrors", function () {
                var n = u.take(["err", "ierr"]), e = {body: n, qs: {}}, t = x(m.releaseIds);
        ...
        function r(n, e, t) {
            ...
            if (!(g.length >= v)) {
                ...
                u(l, r), u(y, r), t && "object" == typeof t && u(t, r), c.actionName = e || "", g.push(c)
            }
        }
        ...
        var i, a = n("ee"), s = n("loader"), u = n(30), f = n(18), c = n(13), l = n(8), p = n(4), m = n(11), d = 120,
            h = 10, v = d * h / 60, g = [], y = s.info.jsAttributes = {};
        document.referrer && (i = p(document.referrer)), c("api-setCustomAttribute", o, "api"), a.on("feat-ins", function () {
            c("api-addPageAction", r), l.on("ins", function () {
        ...
        function o(n, e, t, r) {
            ...
            var i = {n: r, s: e - w.offset, e: t - w.offset, o: "window", t: o};
            l(i)
        }

        function i(n, e, t, r) {
            if (n.type in R) return !1;
            var o = {n: a(n.type), s: t - w.offset, e: r - w.offset, o: s(n.target, e), t: "event"};
            l(o)
        }
        ...
        function m() {
            ...
            var n = j(k(C, function (n, e) {
                return n in N ? j(k(j(e.sort(d), h(n), {}), v), g, []) : e
            }), g, []);
            if (0 === n.length) return {};
            C = {};
            var e = {qs: {st: "" + w.offset, ptid: q}, body: {res: n}};
            if (!q) {
        ...
        var w = n("loader"), x = n(13), b = n(8), k = n(30), j = n(32), E = n(18), S = n(31), A = n(28), T = n(11);
        if (b.xhrUsable) {
            var q = "", R = {mouseup: !0, mousedown: !0},
                N = {typing: [1e3, 2e3], scrolling: [100, 1e3], mousing: [1e3, 2e3], touching: [1e3, 2e3]}, L = {
            ...
            if (e.exports = {_takeSTNs: m}, n(16), w.features.stn) {
                U.on("feat-stn", function () {
                    r(window.performance.timing), b.on("resources", p(m));
                    var n = b.sendX("resources", w, {needResponse: !0});
                    n.addEventListener("load", function () {
                        q = this.responseText
                    }, !1), x("bst", i), x("bstTimer", o), x("bstResource", f), x("bstHist", u), x("bstAgg", c), x("bstApi", l), T(function () {
                        var n = 0;
        ...
        var o = n(2), i = n(13), a = n(8), s = n(18), u = n("loader"), f = n("ee");
