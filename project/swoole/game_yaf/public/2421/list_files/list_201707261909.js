...
!function t(e, n, o) {
        ...
        !function (e) {
            ...
            i.prototype.events = function () {
                ...
                var t = this,
                    ...
                    i = new RegExp("^[一-龥]{2,4}$"), a = e(".modal-account")[0], r = e(".modal-name")[0];
    ...
    7: [function (t, e, n) {
        !function () {
            ...
            var n = !0, o = 1;
            loadingStatus = !1;
            var a = [], r = "getRecordList", s = "/activity/result", l = {
                loaded: function (t) {
                    ...
                    if (!loadingStatus) {
                        ...
                        n ? ($(".loading-img").show(), $(".loading-tip").html("正在加载中"), o++, l.getMoreItems()) : ($(".loading-img").hide(), $(".loading-tip").html('已经没有更多了！<a href="overdue.html" class="overdue">查看已过期的奖品></a>'))
                    }
                }, events: function () {
                    var t = this;
                    $("body").on("click", ".item", function () {
                        ...
                        switch (e) {
                            ...
                            case"wait":
                                ...
                                break;
                            default:
                                window.location.href = "detail.html?orderId=" + n
                    ...
                    var t = this;
                    c({url: r}, {currentPage: o}, function (e) {
                        if (e.success) {
                            var r = e.data, s = [];
                            ...
                            if (n = !!r.totalCount && Math.ceil(r.totalCount / 50) != o, d(l, $("#obj-item").html(), $(".obj-list")), t.loaded(n), a.length < 7 || 0 == s.length) if (console.log(s), 0 === $(".loading").length) {
                                var c = '<div class="loading"><span class="loading-tip">已经没有更多了！<a href="overdue.html" class="overdue">查看已过期的奖品></a></span></div>';
                                $("body").append(c)
                            } else 0 === $(".overdue").length && $(".loading-tip").html('已经没有更多了！<a href="overdue.html" class="overdue">查看已过期的奖品></a>');
                    ...
                    var t = this;
                    c({url: s, type: "get"}, {orderId: t.clickOrderId}, function (t) {
                ...
                init: function () {
                    ...
                    e.cache = [], t("[" + e.attr + "]").not("[is-load]").each(function () {
                        if (t(this).attr(e.attr)) {
                            var n = this.nodeName.toLowerCase(), o = t(this).attr(e.attr),
                                i = {obj: t(this), tag: n, url: o};
                            e.cache.push(i)
                        }
                    })
                }, loading: function () {
                    var o = n.height(), i = n.width();
                    if (n.get(0) === window) var a = t(window).scrollTop(),
                        r = t(window).scrollLeft(); else var a = n.offset().top, r = n.offset().left;
                ...
                init: function (e) {
                    ...
                    n.bind("scroll", function () {
                        clearTimeout(e), e = setTimeout(function () {
                            var e = t(window).scrollTop(), n = t(window).height(), o = t(document).height(),
                                a = i.bottom;
        ...
        (function (t) {
            !function () {
                var n = function s() {
                    ...
                    var e, n, o, i = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, a = /,/, r = /^\s*(_?)(\S+?)\1\s*$/,
                        s = /^function[^{]+{([\s\S]*)}/m, l = [];
                ...
                n.__cache = {}, n.version = "0.6.14", n.settings = {}, n.documentHTML = "", n.tags = {
                    ...
                    var t = n.tags.operationOpen + "each\\s*([^}]*?)\\s*as\\s*(\\w*?)\\s*(,\\s*\\w*?)?" + n.tags.operationClose,
                        e = n.tags.operationOpen + "\\/each" + n.tags.operationClose,
                        o = n.tags.operationOpen + "if\\s*([^}]*?)" + n.tags.operationClose,
                        i = n.tags.operationOpen + "\\/if" + n.tags.operationClose,
                        a = n.tags.operationOpen + "else" + n.tags.operationClose,
                        r = n.tags.operationOpen + "else if\\s*([^}]*?)" + n.tags.operationClose,
                        s = n.tags.interpolateOpen + "([\\s\\S]+?)" + n.tags.interpolateClose,
                        l = n.tags.noneencodeOpen + "([\\s\\S]+?)" + n.tags.noneencodeClose,
                        c = n.tags.commentOpen + "[^}]*?" + n.tags.commentClose,
                        d = n.tags.operationOpen + "each\\s*(\\w*?)\\s*in\\s*range\\(([^}]+?)\\s*,\\s*([^}]+?)\\)" + n.tags.operationClose,
                        p = n.tags.operationOpen + "include\\s*([^}]*?)\\s*,\\s*([^}]*?)" + n.tags.operationClose,
                        u = n.tags.operationOpen + "helper\\s*([^}]*?)\\s*" + n.tags.operationClose, f = "([\\s\\S]*?)",
                        m = n.tags.operationOpen + "\\/helper" + n.tags.operationClose;
