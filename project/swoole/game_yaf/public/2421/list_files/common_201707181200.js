...
!function t(i, e, o) {
    ...
    1: [function (t, i, e) {
        $.cookie = function (t, i, e) {
            ...
            var c = e.path ? "; path=" + e.path : "", h = e.domain ? "; domain=" + e.domain : "",
                d = e.secure ? "; secure" : "";
    ...
    3: [function (t, i, e) {
        i.exports = '<div id="recommend-modal" class="recommend-modal"><div class="recommend-modal-dialog"> <i class="icon close" db-exposure="{{stRecommendInfo}}" db-disabled-web=true></i><i class="icon points"></i><div class="recommend-header"></div><div class="recommend-body">{{if !block1}}<img class="recommend-over1" src="//yun.tuia.cn/h5-tuia/recommend/over1.png">{{else}}<img class="recommend-over2" src="//yun.tuia.cn/h5-tuia/recommend/over2.png"><a class="recommend-list" href="javascript:void(0);" onclick="setPosition(2, \'{{block1.actUrl}}\')"><img src="{{block1.bannerUrl}}"><div class="recommend-title">{{block1.title}}</div><div class="recommend-attend">立即参加 &gt;</div></a>{{if block2}}<a class="recommend-list" href="javascript:void(0);" onclick="setPosition(3, \'{{block1.actUrl}}\')"><img src="{{block2.bannerUrl}}"><div class="recommend-title">{{block2.title}}</div><div class="recommend-attend">立即参加 &gt;</div></a>{{/if}}{{/if}}</div></div></div>'
    }, {}],
    4: [function (t, i, e) {
        !function (t) {
            var i = function (t) {
        ...
        !function (i) {
            ...
            s.prototype.events = function () {
                ...
                var t = this,
                    ...
                    s = new RegExp("^[一-龥]{2,4}$"), n = i(".modal-account")[0], r = i(".modal-name")[0];
            ...
            s.prototype = {
                version: "5.2.0", _init: function () {
                    ...
                    if (this.enabled && l.eventType[t.type] === this.initiated) {
                        ...
                        var i, o, s, n, r = t.touches ? t.touches[0] : t, a = r.pageX - this.pointX,
                            c = r.pageY - this.pointY, h = l.getTime();
                    ...
                    if (this.enabled && l.eventType[t.type] === this.initiated) {
                        ...
                        var i, o, s = (t.changedTouches ? t.changedTouches[0] : t, l.getTime() - this.startTime),
                            n = e.round(this.x), r = e.round(this.y), a = e.abs(n - this.startX),
                            c = e.abs(r - this.startY), h = 0, d = "";
                    ...
                    var i, e = this.options.interactiveScrollbars, o = "string" != typeof this.options.scrollbars,
                        s = [], a = this;
                    ...
                    this.currentPage = {}, "string" == typeof this.options.snap && (this.options.snap = this.scroller.querySelectorAll(this.options.snap)), this.on("refresh", function () {
                        var t, i, o, s, n, r, a = 0, l = 0, c = 0, h = this.options.snapStepX || this.wrapperWidth,
                    ...
                    if (this.enabled) {
                        var i, o = this.options.snap, s = o ? this.currentPage.pageX : this.x,
                            n = o ? this.currentPage.pageY : this.y, r = l.getTime(), a = this.keyTime || 0, c = .25;
    ...
    19: [function (t, i, e) {
        ...
        !function () {
            ...
            function n(i, e) {
                ...
                var r = e.debug, a = e.openTag, l = e.closeTag, c = e.parser, h = e.compress, d = e.escape, p = 1,
            ...
            a.parser = function (t, i) {
                ...
                switch (o) {
                    ...
                    case"/if":
                        ...
                        break;
                    case"each":
                        var n = e[0] || "$data", a = e[1] || "as", l = e[2] || "$value", c = e[3] || "$index",
                            h = l + "," + c;
