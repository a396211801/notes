...
!function t(e, n, i) {
    ...
    1: [function (t, e, n) {
        ...
        var i = "function" == typeof Symbol && "symbol" === _typeof2(Symbol.iterator) ? function (t) {
            ...
            var E, C, S, k, T, j, N = [], A = N.slice, O = N.filter, L = window.document, P = {}, _ = {}, D = {
                "column-count": 1,
                columns: 1,
                "font-weight": 1,
                "line-height": 1,
                ...
                "z-index": 1,
                zoom: 1
            }, I = /^\s*<(\w+|!)[^>]*>/, F = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, M = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, q = /^(?:body|html)$/i, $ = /([A-Z])/g, R = ["val", "css", "html", "text", "data", "width", "height", "offset"], B = ["after", "prepend", "before", "append"], z = L.createElement("table"), Z = L.createElement("tr"), W = {
                ...
                th: Z,
                "*": L.createElement("div")
            }, U = /complete|loaded|interactive/, X = /^[\w-]*$/, G = {}, H = G.toString, V = {}, Y = L.createElement("div"), J = {
                tabindex: "tabIndex",
                readonly: "readOnly",
                "for": "htmlFor",
                "class": "className",
            ...
            return V.matches = function (t, e) {
                ...
                var i, r, o;
                return F.test(t) && (i = S(L.createElement(RegExp.$1))), i || (t.replace && (t = t.replace(M, "<$1></$2>")), e === E && (e = I.test(t) && RegExp.$1), e in W || (e = "*"), o = W[e], o.innerHTML = "" + t, i = S.each(A.call(o.childNodes), function () {
                    o.removeChild(this)
                ...
                var i;
                if (!t)return V.Z();
                if ("string" == typeof t)if (t = t.trim(), "<" == t[0] && I.test(t)) i = V.fragment(t, RegExp.$1, n), t = null; else {
                    if (n !== E)return S(n).find(t);
                    i = V.qsa(L, t)
                } else {
                    if (e(t))return S(L).ready(t);
                    if (V.isZ(t))return t;
                    if (K(t)) i = c(t); else if (o(t)) i = [t], t = null; else if (I.test(t)) i = V.fragment(t.trim(), RegExp.$1, n), t = null; else {
                        if (n !== E)return S(n).find(t);
                        i = V.qsa(L, t)
                    }
                }
                ...
                data: function (t, e) {
                    var n = "data-" + t.replace($, "-$1").toLowerCase(), i = 1 in arguments ? this.attr(n, e) : this.attr(n);
                    return null !== i ? w(i) : E
                },
                val: function (t) {
                    return 0 in arguments ? this.each(function (e) {
