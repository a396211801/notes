...
FloatModel.prototype = {
    ...
    floatHorse: function () {
        ...
        setTimeout(function () {
            $('.horse').css({
                "background-image": "url(/4001/images/floatleft.gif)"
            })
    ...
    floatRedRain: function () {
        ...
        $(function () {
            ...
            html += '<div class="airplane floatclick">' +
                '<img src="/4001/images/airplane1.gif" alt="双11抢红包" class="air"/>' +
                '<img src="/4001/images/flag.gif" alt="双11抢红包" class="flag"/></div>' +
            ...
            $('.airplane').animate({
                ...
                function Pack() {
                    ...
                    redPack.src = "/4001/images/pack.png";
        ...
        setTimeout(function () {
            ...
            if (!($(".redPack,.planes").length)) {
                $('.airplane').css({
                    'width': 3 + 'rem',
                    'height': 3 + 'rem',
                    'background-image': 'url(/4001/images/float1.gif)'
                })
    ...
    floatSuperMarket: function () {
        ...
        addCssByStyle('.market {position:absolute;width:4.825rem;height:4rem;background-image:url(/4001/images/3.gif);background-repeat: no-repeat;background-size: 100% 100%;' +
            ...
            'right: 0;top: 18rem;display: none; z-index:2001;}.person{width:2.025rem;height: 4rem;background-image:url(/4001/images/person.gif);background-repeat: no-repeat;background-size: 100% 100%;}' +
            '.car {width:4rem;height: 4rem;top:4rem;background-image:url(/4001/images/car.gif);background-repeat: no-repeat;background-size: 100% 100%;position: absolute;right: 1rem;}')
        $(function () {
            var html = '', self = this;
            ...
            $('.market').animate({
                ...
                $('.market').css({
                    'background-image': 'url(/4001/images/2.gif)'
                })
