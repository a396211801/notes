                        ...
                        if (window.performance) {
                            ...
                            if (window.allEnd =+ new Date, n.loadEventEnd) {
                                ...
                                var r = n.domComplete - n.domInteractive,
                                    ...
                                    f = "/activity/activityPagePerf?skinName=" + CFG.skinName + "&activityType=" + CFG.activityType + "&activityId=" + CFG.activityId + "&domComplete=" + r + "&domLoaded=" + a + "&onload=" + s + "&white=" + c + "&dbStyle=" + u + "&all=" + l + "&netWork=" + o.getNetwork(),
                                    d =+ new Date,
                                    h = {
                                        url: f,
                                        type: "post",
                ...
                o = {
                    initJoinParams: function (t) {
                        ...
                        window.Plugin_Act_CFG = {
                            ...
                            moreEmbedData: c,
                            getOrder: "/activity/dojoin",
                            getLottery: "/activity/result"
                        }
                    },
                    getCount: function (t) {
                        var e = i.getCache(t);
