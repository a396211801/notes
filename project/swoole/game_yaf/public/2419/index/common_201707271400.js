            ...
            var e = t("../../unit/lib/lib-template/0.0.0/artTemplate"), o = {
                init: function (e) {
                    ...
                    CFG.isShowRecommend ? this.ajax(function (t) {
                            t.recommend = !0, o.render(i("body"), t, s), i("#recommend-modal").show(), window.DB && window.DB.exposure && window.DB.exposure.initLog(), e && e()
                        }) : o.render(i("body"), {recommend: !1}, s)
                    ...
                    i.ajax({
                        ...
                        type: "post",
                        dataType: "json",
                        data: {id: this_id, random: this_random},
                        success: function (i) {
        ...
        !function (i) {
            var e = function (t) {
                ...
                if ("object" === ("undefined" == typeof e ? "undefined" : o(e))) {
                    ...
                    this.prize = e.prize || {}, this.prize = i.extend(!0, s, this.prize), i("body").append(n.tpl1(n.prize)).append(n.tpl2(n.prize)), document.ontouchmove = function (t) {
                        t.preventDefault()
                    }, e.showPage2 && (i(".modal-container1").hide(), i(".modal-container2").show()), n.exposure(), n.events()
            ...
            s.prototype.events = function () {
                ...
                e.on("click", ".modal-body, .modal-btn", function () {
                    ...
                    e.remove(), o.remove(), document.ontouchmove = null, i(".modal-result").remove();
                    var s = t.callback;
                    s && s.close && s.close()
                }), o.on("focus", "input", function () {
                    t.hideTip(), i(".modal-container1,.modal-container2").css("position", "absolute")
        ...
        !function (t, i, e) {
            ...
            s.prototype = {
                version: "5.2.0", _init: function () {
                    ...
                    e(t, "orientationchange", this), e(t, "resize", this), this.options.click && e(this.wrapper, "click", this, !0), this.options.disableMouse || (e(this.wrapper, "mousedown", this), e(o, "mousemove", this), e(o, "mousecancel", this), e(o, "mouseup", this)), l.hasPointer && !this.options.disablePointer && (e(this.wrapper, l.prefixPointerEvent("pointerdown"), this), e(o, l.prefixPointerEvent("pointermove"), this),
                        e(o, l.prefixPointerEvent("pointercancel"), this), e(o, l.prefixPointerEvent("pointerup"), this)), l.hasTouch && !this.options.disableTouch && (e(this.wrapper, "touchstart", this), e(o, "touchmove", this), e(o, "touchcancel", this), e(o, "touchend", this)), e(this.scroller, "transitionend", this), e(this.scroller, "webkitTransitionEnd", this), e(this.scroller, "oTransitionEnd", this), e(this.scroller, "MSTransitionEnd", this)
