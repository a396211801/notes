...
!function t(i, e, s) {
    ...
    1: [function (t, i, e) {
        ...
        var s = {
            events: {}, trigger: function (t) {
                for (var i = this.events[t], e = 0, s = i.length; e < s; e++)i[e].apply(null, [].slice.call(arguments, 1))
            }, on: function (t, i) {
                (this.events[t] = this.events[t] || []).push(i)
            }
        };
        i.exports = s
    }, {}], 4: [function (t, i, e) {
        var s = t("./event"), o = [[300, 380, 400], [260, 280, 350], [90, 90, 90]], n = 5, r = 5e3, a = ["row1", "row2", "row3"], h = 640 * window.remScale, l = h, c = r, p = l / c, d = c / 5, u = {
            status: "ready",
            start: function () {
                this._reset(), this._startFloat(), this._spyFloat()
            },
            pick: function () {
                this.status = "pick"
            },
            ...
            _startFloat: function () {
                function t() {
                    var t = Math.ceil(2 * Math.random());
                    $(".mac-container .floats").append(2 === t ? '<div class="item float" data-type="box">\n            <div class="prize">\n              <div class="box"></div>\n              <div class="bubble bubble2"></div>\n            </div>\n          </div>' : '<div class="item float" data-type="bottle">\n            <div class="prize">\n              <div class="bottle"></div>\n              <div class="bubble"></div>\n            </div>\n          </div>');
                    var i = l + "px,0,0";
                    $(".mac-container .float").last().addClass(f.getRandomStyle()).animate({translate3d: i}, c, "linear", function () {
                        $(this).remove()
                    })
                }

                this.speed = p, t(), setInterval(t, d)
            },
            _spyFloat: function () {
                var t = this;
                setInterval(function () {
                    "pick" === t.status && $(".mac-container .float").each(function (i, e) {
                        if (!$(e).data("isReady")) {
                            var r = f.getTranslateX(e), a = parseInt(e.className.match(/row(\d)$/)[1]) - 1, h = window.FishingGold.column, l = o[a][h], c = n;
                            2 !== window.FishingGold.result.data.result && (c = 50);
                            var p = (l - c) * window.remScale, d = (l + c) * window.remScale, u = 1e3 * t.speed;
                            p - u <= r && r <= d - u && ($(e).data("isReady", !0), s.trigger("startFish", e), t._reset(), console.log("row:", a + 1, "column:", h + 1))
                        }
                    })
                }, 20)
            }
        }, f = {
            _getRandom: function (t, i) {
                return Math.floor(Math.random() * (i - t + 1) + t)
            }, getRandomStyle: function () {
                var t = a;
                return t[this._getRandom(0, t.length - 1)]
            }, getTranslateX: function (t) {
                var i = window.getComputedStyle(t, null), e = i.getPropertyValue("-webkit-transform") || i.getPropertyValue("transform"), s = e.replace(/\s/gi, "");
                return parseFloat(s.split(",")[4])
            }
        };
        i.exports = u
    }, {"./event": 3}], 5: [function (t, i, e) {
        !function (i) {
            t("../../../../../unit/lib/lib-animate/1.0.0/animate"), t("../../../../../unit/common/js/IScroll"), t("../../../../../module/guide/guide"), t("../../components/prizesRender");
            var e = t("./playgame"), s = t("./floatMac"), o = t("./event");
            FastClick(document.body);
            var n = {
                hasNoTimes: !1, againOrderId: null, playgame: null, guide: null, init: function () {
                    this.browser.versions.ios || this.browser.versions.iPad ? i(".apple").show() : i(".apple").hide(), this.getStyle(), this.getOption(), this.events()
                }, getStyle: function () {
                    var t = this;
                    t.getTuiaStyle({
                        success: function (e) {
                            if (e.success) {
                                var s = [["#fishinggold", "backgroundImage", "bgImage"], [".record", "backgroundImage", "record"], [".banner", "backgroundImage", "theme"], [".apple", "backgroundColor", "appleBgColor"], [".apple", "color", "apple"], ["body", "backgroundColor", "bgColor"], [".prizelist", "backgroundColor", "prizeBgColor"], [".prizelist .prize-tag", "backgroundImage", "prizetag"], [".rule-btn", "backgroundImage", "ruleImage"], [".person-container .platform .person .p1", "backgroundImage", "p1"], [".person-container .platform .person .p2", "backgroundImage", "p2"], [".person-container .platform .person .p3", "backgroundImage", "p3"], [".person-container .platform .person .p4", "backgroundImage", "p4"], [".person-container .platform .person .p5", "backgroundImage", "p1"], [".sea .prizebox .item .bottle", "backgroundImage", "bottle"], [".person-container .platform .fishing .basket .result.bottle", "backgroundImage", "bottle"], [".sea .prizebox .item .box", "backgroundImage", "box"], [".person-container .platform .fishing .basket .result.box", "backgroundImage", "box"], [".btn .startbtn", "backgroundImage", "startbtn"], [".btn .startbtn:active", "backgroundImage", "startbtnclicked"], [".btn .startbtn[disabled]", "backgroundImage", "disabledbtn"], [".rule-modal .rule-modal-dialog", "backgroundColor", "ruleBgColor"], [".rule-modal .rule-modal-dialog section .probability", "backgroundColor", "ruleBgColor"], [".rule-modal .rule-modal-dialog header span,.rule-modal .rule-modal-dialog section .description", "color", "ruleTextColor"], [".rule-modal .rule-modal-dialog header i", "backgroundColor", "ruleTextColor"], [".rule-modal .rule-modal-dialog .close", "color", "ruleTextColor"], [".rule-modal .rule-modal-dialog section .probability .nav", "backgroundColor", "probabilityBg"], [".rule-modal .rule-modal-dialog section .probability .nav span", "color", "probabilityColor"], [".rule-modal .rule-modal-dialog section .probability.active .text", "color", "ruleTextColor"], [".description-scroller", "html", "ruleText"]];
                                requireStyle.init(e, s), i("head").append("<style>.rule-modal .rule-modal-dialog section .probability .nav i{border-top-color: " + requireStyle.getStyle("probabilityColor") + " !important;border-left-color: " + requireStyle.getStyle("probabilityColor") + " !important;}</style>"), requireStyle.getStyle("probabilityText") && (requireStyle.setConfig(".probability-scroller", "html", "probabilityText"), i(".probability").show()), window.isNew = e.data.isNew, setTimeout(function () {
                                    for (var t = 1; t <= 4; t++) {
                                        var i = new Image;
                                        i.src = requireStyle.getStyle("p" + t)
                                    }
                                    for (var e = 1; e <= 12; e++) {
                                        var i = new Image;
                                        i.src = CFG.host + "/h5/activity/fishinggold/images/wave" + e + ".png"
                                    }
                                }, 300), i(document).height() >= i(window).height() && i(".apple").removeClass("fixed"), i("#fishinggold").show()
                    ...
                    t.getTuiaOptions({
                        success: function (i) {
                            if (i.success) {
                                var e = i.data;
                                t.renderElement(e), window.prizesRender("#prize-list", {
                                    prizes: i.data.options,
                                    itemWidth: .5,
                                    spaceBetween: .125,
                                    slidesOffsetAfter: 0
                                }), loader(function () {
                    ...
                    i("#prize-list").on("click", ".prize-item", function () {
                        ...
                        t.reInit()
                    }), this.playgame = new e, i(".startbtn").on("click", function () {
                        setPosition(1);
                        return !i(".startbtn").prop("disabled") && (t.hasNoTimes ? (t.showModal("over"), !1) : (i(".startbtn").prop("disabled", !0), t.guide && t.guide.hide(), void t.playgame.start(t.getOrder)))
                    })
                }, getOrder: function () {
                    var t = n, i = {};
                    t.againOrderId && (i.againOrderId = t.againOrderId), t.getTuiaOrder({
                        data: i, success: function (i) {
                            ...
                            "timeout" == e ? (window.xhr && window.xhr.abort(), t.showModal("systemError", {message: "????????????"})) : t.showModal("networkError")
                        }
                    })
                    ...
                    this.getTuiaLottery({
                        data: {orderId: t}, success: function (e) {
                            ...
                            "success" == s ? "wait" == e.data.status ? setTimeout(function () {
                                        i.getLottery(t)
                                    }, 1e3) : "success" == e.data.status && (i.againOrderId = e.data.againTag ? e.data.againTag : null, i.fishingResult(e)) : "networkError" == s ? i.showModal("networkError") : i.fishingResult({data: {result: 0}}, function () {
                                        i.showModal("noPrize")
                                    })
                        }, error: function (t, e) {
                            "timeout" == e ? (window.xhr && window.xhr.abort(), i.showModal("systemError", {message: "????????????"})) : i.showModal("networkError")
                        }
                    })
                    ...
                    i(".prize-modal").hide(), i("#fishinggold").removeClass("filter-blur"), i(".startbtn").prop("disabled", !1), this.playgame && this.playgame.reset(), buoyInit && buoyInit(this.isShowBuoy)
                }, fishingResult: function (t) {
                    var i = this;
                    s.pick(), window.FishingGold.result = t, o.on("startFish", function (e) {
                        i.playgame.fishing(t, function () {
                            0 == t.data.result ? i.showModal("noPrize") : 1 == t.data.result ? i.showModal("again") : i.showPrizeModal(t)
                        }, e)
                    })
                }, showPrizeModal: function (t) {
                    var e = this, s = t.data.lottery;
                    if ("coupon" == s.type || "lucky" == s.type) {
                        var o = function () {
                            window.showCouponPrize({
                                result: t.data, callback: {
                                    close: function () {
                                        e.hideModal()
                                    }, use: function () {
                        ...
                        name: s.title, type: s.type, img: s.imgurl, onsubmit: function () {
                            window.location.href = s.link
                        }, onclose: function () {
                            i(".prize-dialog-modal").hide(), e.hideModal()
                        }
                    })
                }, renderElement: function (t) {
                    i(".needcredit").html(this.getTuiaStatusText(t)).show(), t.limitTimes || CFG.preview ? this.hasNoTimes = !1 : this.hasNoTimes = !0
                }, browser: {
                    versions: function () {
            ...
            n = i.extend({}, n, window.Public), n.init()
        }(Zepto)
    }, {
        "../../../../../module/guide/guide": 1,
        "../../../../../unit/common/js/IScroll": 7,
        "../../../../../unit/lib/lib-animate/1.0.0/animate": 8,
        "../../components/prizesRender": 2,
        "./event": 3,
        "./floatMac": 4,
        "./playgame": 6
    }], 6: [function (t, i, e) {
        function s() {
            var t = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame || function (t) {
        ...
        function o() {
            var t = h.result, i = h.resultcallback, e = h.target, s = window.FishingGold.column + 1;
            n(), $(".fishing").removeClass("pending").addClass("ani-pole" + s), $(".basket").addClass("ani-basket"), 2 === t.data.result && $(e).addClass("disappear").off(a).on(a, function () {
                $(".basket").find(".result").addClass($(e).data("type") + " result-prize")
            }), setTimeout(function () {
                i && i()
            }, 1500)
        }
        ...
        function n() {
            function t(e) {
                return !(e > 5) && ($(".person i").addClass("hidden"), $(".person .p" + e).removeClass("hidden"), void(h.person1TimeId = setTimeout(function () {
                        e <= 4 && t(e + 1)
                    }, i)))
            }
        ...
        var r = [75, 85, 95], a = function () {
            var t = function () {
                var t = "transition", i = document.body || document.documentElement, e = i.style, s = 0, o = ["Moz", "Webkit", "Khtml", "O", "ms"];
                for (t = t.charAt(0).toUpperCase() + t.substr(1); s < o.length;) {
                    if ("string" == typeof e[o[s] + t])return o[s];
                    s++
                }
                return !1
            }();
            return "Webkit" == t ? "webkitAnimationEnd" : "animationend"
        }(), h = {}, l = function () {
            return this.reset(), h["this"] = this, this
        };
        l.prototype.start = function (t) {
            return !h.isplay && (h.isplay = !0, $(".fishing").removeClass("ready").addClass("pending"), t && t(), void(h.poleStart || this.polewidthChange()))
        }, l.prototype.polewidthChange = function () {
            function t() {
                h.poleStop ? o() : s()(t)
            }

            var i = r;
            column = Math.ceil(3 * Math.random()) - 1, w_MAX = i[column];
            var e = w_MAX, n = $(".person-container .fishing");
            window.FishingGold = {}, window.FishingGold.column = column, n.css("width", e + "%"), h.poleStart = !0, t()
        }, l.prototype.fishing = function (t, i, e) {
            h.poleStop = !0, h.result = t, h.resultcallback = i, h.target = e
        }, l.prototype.reset = function () {
            h.isplay = !1, $(".fishing,.basket,.basket .result,.prizebox .item").removeClass(function (t, i) {
                return (i.match(/\bani-\S+/g) || []).join(" ")
            }), $(".basket .result").removeClass("box bottle"), $(".fishing").css("width", "100%").addClass("ready"), h.poleStop = null, h.result = null, h.resultcallback = null, h.poleStart = null, h.person1TimeId && clearTimeout(h.person1TimeId), h.poleStart || this.polewidthChange()
        }, i.exports = l
    }, {}], 7: [function (t, i, e) {
        ...
        !function (t) {
            ...
            t.each(m, function (t, i) {
                ...
                var b, w, x, S = {}, T = "", k = this, E = t.fx.transitionEnd, P = !1;
                if (void 0 === o && (o = t.fx.speeds._default / 1e3), void 0 === g && (g = 0), t.fx.off && (o = 0), "string" == typeof e) S[c] = e, S[p] = o + "s", S[u] = g + "s", S[d] = f || "linear", E = t.fx.animationEnd; else {
                    w = [];
                    for (b in e)v.test(b) ? T += b + "(" + e[b] + ") " : (S[b] = e[b], w.push(i(b)));
                    T && (S[n] = T, w.push(n)), o > 0 && "object" === ("undefined" == typeof e ? "undefined" : s(e)) && (S[r] = w.join(", "), S[a] = o + "s", S[l] = g + "s", S[h] = f || "linear")
                }
                return x = function (i) {
                    if ("undefined" != typeof i) {
                        if (i.target !== i.currentTarget)return;
                        t(i.target).unbind(E, x)
                    } else t(this).unbind(E, x);
                    P = !0, !t(this).attr("stop") && t(this).css(y), m && m.call(this)
                }, o > 0 && (this.bind(E, x), setTimeout(function () {
                    P || x.call(k)
