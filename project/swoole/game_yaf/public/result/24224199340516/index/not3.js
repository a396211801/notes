...
function postcheck(){ 	
 ...
 if (document.getElementById("zsid").value=="1") {
  try{
     ...
     if(numb==0) {
      alert("还未选择【"+zsshuxing[0]+"】，请选择后再提交3");
      return false;
      }
      }
 }
  ...
  try{
     ...
     if(numb==0) {
      alert("还未选择【"+zsshuxing[1]+"】，请选择后再提交4");
      return false;
      }
      }
 }
  ...
  try{
     ...
     if(numb==0) {
      alert("还未选择【"+zsshuxing[2]+"】，请选择后再提交5");
      return false;
      }
      }
 }
