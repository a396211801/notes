...
<head>
    ...
    <script type="text/javascript">
        window.NREUM || (NREUM = {}), __nr_require = function (t, e, n) {
            ...
            1: [function (t, e, n) {
                ...
                var u = ["setPageViewName", "setCustomAttribute", "setErrorHandler", "finished", "addToTrace", "inlineHit", "addRelease"], d = "api-", l = d + "ixn-";
                a(u, function (t, e) {
                    f[e] = o(d + e, !0, "api")
    ...
    <style>.main {
            background-image: url(/2244/0dd0kquumx.png) !important;
        }

        body {
            background-color: #9ef6ff !important;
        }

        .record {
            background-image: url(/2244/byws56juad.png) !important;
        }

        .rule {
            background-image: url(/2244/1eERS1476708099636.png) !important;
        }

        .prize-tag {
            background-image: url(/2244/r1CRf1476708099539.png) !important;
        }

        .prize-list {
            background-color: #24c5d6 !important;
        }

        .prize-list .prize-img-box {
            background-color: #fff !important;
        }

        .prize-list .prize-img-box, .prize-list {
            border-color: #592006 !important;
        }

        .apple {
            color: #592006 !important;
        }
        ...
        .wawa.box1 .prize {
            background-image: url(/2244/p0jioybvtv.png) !important;
        }

        .wawa.box2 .prize {
            background-image: url(/2244/1l2k57vjww.png) !important;
        }

        .wawa.box3 .prize {
            background-image: url(/2244/0845d50bhz.png) !important;
        }

        .mactop {
            background-image: url(/2244/ucf1zwqy7v.png) !important;
        }

        .macborder {
            background-image: url(/2244/qvnof8x6tx.png) !important;
        }

        .macbg {
            background-image: url(/2244/fhgh20ohzr.png) !important;
        }

        .conveyorBelt {
            background-image: url(/2244/gnqehtj47o.png) !important;
        }

        .conveyorBelt.backward .maoding i, .conveyorBelt.forward .maoding i {
            background-image: url(/2244/QOXWj1476708099539.png) !important;
        }

        .start {
            background-image: url(/2244/X0UyT1476708099650.png) !important;
        }

        .start:active {
            background-image: url(/2244/aCG9c1476708099654.png) !important;
        }

        .start[disabled] {
            background-image: url(/2244/g9pyQ1476708099728.png) !important;
        }

        .rule-modal .rule-modal-dialog {
            background-color: #f0a665 !important;
        }
        ...
        .rule-modal .rule-modal-dialog section .probability .nav {
            background-color: #9d5627 !important;
        }
    ...
    <!-- 首屏加载公用js、css -->
    <link rel="stylesheet" href="//yun.yuyiya.com/h5-tuia/common/actBase_201707271400.css">
</head>
<link rel="stylesheet" type="text/css" href="//yun.yuyiya.com/h5-tuia/activity/dollMac/1.0/index_201707271400.css"/>
</head>
<body>
<div id="db-content">
    <div class="main">
        <a class="record" onclick="setPosition(4, '/prize/list/')"></a>
        <div class="rule"></div>
        <div class="dollMac">
            <div class="macbg"></div>
...
<script type="text/javascript" src="/2244/index_201707271400.js"></script>
