...
<head>
    ...
    <style>
        .main {
            background-image: url(/2427/index/5u5upyx5k9.png) !important;
        }
        ...
        .record {
            background-image: url(/2427/index/prize2.png) !important;
        }

        .rule {
            background-image: url(/2427/index/rule2.png) !important;
        }
        ...
        .dice-content.ready {
            background-image: url(/2427/index/dice.png) !important;
        }

        .dice-content.end1 {
            background-image: url(/2427/index/result1.png) !important;
        }

        .dice-content.end2 {
            background-image: url(/2427/index/result2.png) !important;
        }

        .dice-content.end3 {
            background-image: url(/2427/index/result3.png) !important;
        }

        .dice-content.end4 {
            background-image: url(/2427/index/result4.png) !important;
        }

        .dice-content.end5 {
            background-image: url(/2427/index/result5.png) !important;
        }

        .dice-content.end6 {
            background-image: url(/2427/index/result6.png) !important;
        }

        .start {
            background-image: url(/2427/index/btn.png) !important;
        }

        .start.moving {
            background-image: url(/2427/index/btn_click.png) !important;
        }

        .start.end {
            background-image: url(/2427/index/btn_disabled.png) !important;
        }
