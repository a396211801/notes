...
<head>
    ...
    <style>body {
        ...
        .main {
            background-image: url(/2324/index/evng1ixjp8.png) !important;
        }

        .record {
            background-image: url(/2324/index/0hwa3fp1nr.png) !important;
        }
        ...
        .prize-tag {
            background-image: url(/2324/index/N11mK1472645269925.png) !important;
        }
        ...
        .rule {
            background-image: url(/2324/index/rule.png) !important;
        }

        .egg {
            background-image: url(/2324/index/egg.png) !important;
        }

        .egg.active {
            background-image: url(/2324/index/egg-break.png) !important;
        }

        .egg.jump {
            background-image: url(/2324/index/egg-jump.png) !important;
        }

        .chuizi {
            background-image: url(/2324/index/fynXq1472645269907.png) !important;
        }
