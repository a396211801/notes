...
<head>
    ...
    <style>
        #fishinggold {
            background-image: url(/2419/index/bj2.jpg) !important;
        }

        .record {
            background-image: url(/2419/index/record.png) !important;
        }

        .banner {
            background-image: url(/2419/index/vsn84mpzpm.png) !important;
        }
        ...
        .prizelist .prize-tag {
            background-image: url(/2419/index/prizetag.png) !important;
        }

        .rule-btn {
            background-image: url(/2419/index/rulebtn.png) !important;
        }

        .person-container .platform .person .p1 {
            background-image: url(/2419/index/cmjux50gp3.png) !important;
        }

        .person-container .platform .person .p2 {
            background-image: url(/2419/index/z5x4k14l1w.png) !important;
        }

        .person-container .platform .person .p3 {
            background-image: url(/2419/index/hvuxw1kd6m.png) !important;
        }

        .person-container .platform .person .p4 {
            background-image: url(/2419/index/c915lmvcrn.png) !important;
        }
        ...
        .sea .prizebox .item .bottle {
            background-image: url(/2419/index/bottle.png) !important;
        }
        ...
        .sea .prizebox .item .box {
            background-image: url(/2419/index/box.png) !important;
        }
        ...
        .btn .startbtn {
            background-image: url(/2419/index/v5xynafwvf.png) !important;
        }

        .btn .startbtn:active {
            background-image: url(/2419/index/h9phfg079i.png) !important;
        }

        .btn .startbtn[disabled] {
            background-image: url(/2419/index/startBtnDisabled2.png) !important;
        }
...
<div id="db-content">
    <div id="fishinggold" style="display: block;" class="">
        ...
        <a href="javascript:void(0);" onclick="setPosition(4, '/prize/list/')" class="record prize-btn"></a>
...
<a class="buoy" style="display:block;"
   ...
   db-exposure-get="true">
    ...
    <img class="buoyImg" src="/2419/index/swzwd2uklx.gif"></a>
