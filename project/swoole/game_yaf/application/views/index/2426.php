...
<head>
    ...
    <style>body {
            background-color: #258ad0 !important;
        }

        .main {
            background-image: url(/2426/img/luq8hzvuc3.jpg) !important;
        }

        .record {
            background-image: url(/2426/img/yvu564liw5.png) !important;
        }
        ...
        .prize-tag {
            background-image: url(/2426/img/N11mK1472645269925.png) !important;
        }
        ...
        .apple {
            background-color: #429cdb !important;
        }

        .rule {
            background-image: url(/2426/img/rule.png) !important;
        }

        .egg {
            background-image: url(/2426/img/gzhaks1egm.png) !important;
        }

        .egg.active {
            background-image: url(/2426/img/z02q0zk5bo.png) !important;
        }

        .egg.jump {
            background-image: url(/2426/img/j9c9w0gxxp.png) !important;
        }

        .chuizi {
            background-image: url(/2426/img/fynXq1472645269907.png) !important;
        }
        ...
        .rule-modal .rule-modal-dialog section .probability .nav {
            background-color: #e6cd67 !important;
        }
    ...
    <script type="text/javascript">
        window.NREUM || (NREUM = {}), __nr_require = function (t, n, e) {
            ...
            1: [function (t, n, e) {
                ...
                t(5);
                var f = t("ee"), u = f.get("xhr"), d = t(18)(u), l = NREUM.o, p = l.XHR, h = l.MO, m = "readystatechange", w = ["onload", "onerror", "onabort", "onloadstart", "onloadend", "onprogress", "ontimeout"], v = [];
                n.exports = u;
                ...
                }, g = m && w && w[p] && !/CriOS/.test(navigator.userAgent), b = n.exports = {
                    offset: s,
                    now: a,
                    origin: v,
                    features: {},
    ...
    <!-- 首屏加载公用js、css -->
    <link rel="stylesheet" href="/2426/css/actBase_201707271400.css">
</head>
<link rel="stylesheet" type="text/css" href="//yun.yuyiya.com/h5-tuia/activity/smashg/1.0/index_201707271400.css"/>
...
<script type="text/javascript" src="/2426/js/index_201708021832.js"></script>
</body>
</html>
