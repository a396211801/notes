...
class File {
    ...
    public static function get($id) {
        ...
        if (strpos($id, "|") !== FALSE) {
            $arr = explode("|", $id);
            array_pop($arr);
            $instance->_options['cache_dir'] = BASE_PATH . "/cache/" . implode("/", $arr) . "/";
        }
    ...
    protected function __construct() {
        $this->_options['cache_dir'] = BASE_PATH . "/cache/";
    }
