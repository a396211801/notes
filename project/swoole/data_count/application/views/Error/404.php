...
<html>
    ...
    <head>
        ...
        <style type="text/css">
            body { background-image:url(/images/error/bg.jpg);background-position: 40% 0px; ;font-family: "微软雅黑";font: normal 100% Helvetica, Arial,sans-serif 900;}
    ...
    <body>
        <div class="container">
            <div class="container_1"><img src="/images/error/404.png"></div>
            <div class="container_2"><img src="/images/error/3.22.gif" ></div>
