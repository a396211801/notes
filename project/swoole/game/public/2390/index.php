...
<head>
 ...
 type: 'post',
    ...
    <style>
        .banner {
        background-image: url(//yun.yuyiya.com/tuia-media/img/tdp0xvc2ue.png?x-oss-process=image/format,webp) !important;
    }

    .boxImg i {
        background-image: url(//yun.yuyiya.com/tuia-media/img/zxwc1ce4rg.png?x-oss-process=image/format,webp) !important;
    }
    ...
    .main {
        background-image: url(//yun.yuyiya.com/tuia-media/img/q57vbr7jvf.png?x-oss-process=image/format,webp) !important;
    }

    .record {
        background-image: url(//yun.yuyiya.com/tuia-media/img/8e0cqgf1ht.png?x-oss-process=image/format,webp) !important;
    }
    ...
    .rule {
        background-image: url(//yun.yuyiya.com/h5-tuia/activity/cutRope/images/rule.png?x-oss-process=image/format,webp) !important;
    }
...
<a class="buoy" style="display:block;"
   ...
   href="http://activity.yuyiya.com/mainMeet/index?id=143&amp;slotId=3151&amp;deviceId=e47e311d-6007-41b9-96eb-7164611a5ef3&amp;login=normal&amp;appKey=2seQ3FgJVZoJxhiLky6WGEfr1jns&amp;dpm=28155.21.14.2390&amp;dsm=2.14.1.2390&amp;wu=bo">
    ...
    <img class="buoyImg" src="/2390/index/swzwd2uklx.gif"></a></body>
</html>