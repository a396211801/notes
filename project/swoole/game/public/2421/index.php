...
<head>
    ...
    <script id="_1502244514806_2178" src="/2421/index_files/detect.json"></script>
    <link rel="shortcut icon" type="image/x-icon" href="/2421/images/tuia.ico">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
    <meta name="format-detection" content="telephone=no">
    <title>红包</title>
    <script type="text/javascript" async="" src="/2421/index_files/fm.js"></script>
    <!--<script type="text/javascript" src=".//2421/index_files/2214ccb852"></script>-->
    <!--<script src="/2421/index_files/nr-1016.min.js"></script>-->
    <script>
 ...
 type: 'post',
    ...
    <!-- 首屏加载公用js、css -->
    <link rel="stylesheet" href="/2421/index_files/actBase_201707271400.css">
    <link rel="stylesheet" type="text/css" href="/2421/index_files/index_201707271400.css">

    <style>
        .rule {
            background-image: url(/2421/images/rule.png) !important;
        }

        #db-content {
            background-image: url(/2421/images/8obvcew5t7.jpg) !important;
        }
        ...
        .record {
            background-image: url(/2421/images/u0blp4grxr.png) !important;
        }
        ...
        #circle {
            background-image: url(/2421/images/nsz9el4dle.png) !important;
        }
        ...
        .point {
            background-image: url(/2421/images/9k3zkzfu0i.png) !important;
        }

        #start {
            background-image: url(/2421/images/o9i0beptlv.png) !important;
        }

        #start:active {
            background-image: url(/2421/images/xomob6o1vk.png) !important;
        }

        #start.disabled {
            background-image: url(//yun.tuia.cn/tuia-media/img/ua0rn8fbgv.png?x-oss-process=image/format,webp) !important;
        }
    ...
    <script charset="utf-8" async="" src="/2421/index_files/common_201707271400.js"></script>
    <link rel="stylesheet" href="/2421/index_files/common_201707271400.css">
    <script charset="utf-8" async="" src="/2421/index_files/index_201707181200.js"></script>
    <link rel="stylesheet" href="/2421/index_files/index_201707181200.css">
...
<div id="db-content" style="display: block;">
    ...
    <div class="banner">
        <img class="theme" src="/2421/index_files/mnqfcow77s.png">
        <div class="rule"></div>
    </div>
...
<!-- 首屏加载公用js、css -->
<script type="text/javascript" src="/2421/index_files/actBase_201707271400.js"></script>
<link rel="stylesheet" href="/2421/index_files/actBase_201707271400.css">
<script>
...
<!-- 延迟加载公用js、css -->
<script type="text/javascript">
    var common_js = '//yun.tuia.cn/h5-tuia/common/common_201707271400.js';
    var common_css = '//yun.tuia.cn/h5-tuia/common/common_201707271400.css';
</script>
<script type="text/javascript" src="/2421/index_files/index_201707271400.js"></script>
                ...
                <div class="text">
                    <div class="probability-wrapper">
                        <div class="probability-scroller"><p>惊喜一：500元好运红包，共10份，中奖概率为0.03%</p>
                            ...
                            <p>惊喜三：星空晴雨反向伞，共50份，中奖概率为0.07%</p>
