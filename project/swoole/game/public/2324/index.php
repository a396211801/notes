...
<head>
    ...
    <script id="_1502880116293_6747" src="/2324/index/detect.json"></script>
    ...
    <title>新机抢走玩个够（福利中心）</title>
    <script type="text/javascript" async="" src="/2324/index/fm.js"></script>
    <!--<script type="text/javascript" src="/2324/index/2214ccb852"></script>-->
    <script src="/2324/index/nr-1026.min.js"></script>
</script>
 ...
 type: 'post',
    ...
    <!-- 首屏加载公用js、css -->
    <link rel="stylesheet" href="/2324/index/actBase_201707271400.css">
    <link rel="stylesheet" type="text/css" href="/2324/index/index_201707271400.css">
    <style>body {
            background-color: #72cfda !important;
        }

        .main {
            background-image: url(//yun.yuyiya.com/tuia-media/img/evng1ixjp8.png?x-oss-process=image/format,webp) !important;
        }

        .record {
            background-image: url(//yun.yuyiya.com/tuia-media/img/0hwa3fp1nr.png?x-oss-process=image/format,webp) !important;
        }

        .prize-list {
            background-color: rgba(94, 133, 163, 0.9) !important;
        }

        .prize-tag {
            background-image: url(//yun.yuyiya.com/upload/N11mK1472645269925.png?x-oss-process=image/format,webp) !important;
        }
        ...
        .apple {
            background-color: #68c3ce !important;
        }

        .rule {
            background-image: url(//yun.yuyiya.com/h5/activity/turntable_circle/images/rule.png?x-oss-process=image/format,webp) !important;
        }

        .egg {
            background-image: url(//yun.yuyiya.com/h5-tuia/activity/smashg/image/egg.png?x-oss-process=image/format,webp) !important;
        }

        .egg.active {
            background-image: url(//yun.yuyiya.com/h5-tuia/activity/smashg/image/egg-break.png?x-oss-process=image/format,webp) !important;
        }

        .egg.jump {
            background-image: url(//yun.yuyiya.com/h5-tuia/activity/smashg/image/egg-jump.png?x-oss-process=image/format,webp) !important;
        }

        .chuizi {
            background-image: url(//yun.yuyiya.com/upload/fynXq1472645269907.png?x-oss-process=image/format,webp) !important;
        }
        ...
        .rule-modal .rule-modal-dialog section .probability .nav {
            background-color: #ff6c53 !important;
        }
    ...
    <style>.rule-modal .rule-modal-dialog section .probability .nav i {
            border-top-color: #fefcff !important;
            border-left-color: #fefcff !important;
        }</style>
    <style>.prize-list .prize-img-box {
            border-color: rgba(94, 133, 163, 0.9);
        }</style>
    <script charset="utf-8" async="" src="/2324/index/common_201707271400.js"></script>
    <link rel="stylesheet" href="/2324/index/common_201708081700.css">
    <script charset="utf-8" async="" src="/2324/index/index_201707311200.js"></script>
    <link rel="stylesheet" href="/2324/index/index_201708101036.css">
</head>
...
<div id="db-content" style="display: block;">
    ...
    <div class="main">
        <div style="position: relative">
            ...
            <div class="chuizi jump" id="chuizi"></div>
        </div>
        <div class="needCredits">今日免费： 次</div>
    </div>
    <div class="prize-list" id="prize-list">
        <div id="prizes-wrapper" data-length="5"
             style="width: 3.8rem; padding-left: 0.15rem; padding-right: 0rem; transition-timing-function: cubic-bezier(0.1, 0.57, 0.1, 1); transition-duration: 0ms; transform: translate(-70px, 0px) translateZ(0px);">
            <div class="prize-item" style="display: inline-block; margin-right: 0.05rem;" data-id="14845"
                 data-type="physical">
                <div class="prize-img-box"><img class="prize-img" src="/2324/index/ndj99y0iin.png"></div>
                <p class="prize-name">魅族PRO 7</p></div>
            <div class="prize-item" style="display: inline-block; margin-right: 0.05rem;" data-id="14846"
                 data-type="physical">
                <div class="prize-img-box"><img class="prize-img" src="/2324/index/vtb67lmm0p.png"></div>
                <p class="prize-name">华为nova 2</p></div>
            <div class="prize-item" style="display: inline-block; margin-right: 0.05rem;" data-id="14847"
                 data-type="physical">
                <div class="prize-img-box"><img class="prize-img" src="/2324/index/xm0u7iyf40.png"></div>
                <p class="prize-name">200元红包</p></div>
            <div class="prize-item" style="display: inline-block; margin-right: 0.05rem;" data-id="14848"
                 data-type="physical">
                <div class="prize-img-box"><img class="prize-img" src="/2324/index/5gs92an9kg.png"></div>
                <p class="prize-name">20元话费</p></div>
            <div class="prize-item" style="display: inline-block; margin-right: 0.05rem;" data-id="14849"
                 data-type="lucky">
                <div class="prize-img-box"><img class="prize-img" src="/2324/index/lucky.png"></div>
        ...
        <div class="iScrollHorizontalScrollbar iScrollLoneScrollbar"
            ...
            <div class="iScrollIndicator"
                 style="box-sizing: border-box; position: absolute; background: rgba(0, 0, 0, 0.5); border: 1px solid rgba(255, 255, 255, 0.9); border-radius: 3px; height: 100%; transition-duration: 0ms; display: block; width: 319px; transform: translate(61px, 0px) translateZ(0px); transition-timing-function: cubic-bezier(0.1, 0.57, 0.1, 1);"></div>
        </div>
    </div>
...
<script>
    ...
    var egg = document.getElementsByClassName('')
...
<!-- 首屏加载公用js、css -->
<script type="text/javascript" src="/2324/index/actBase_201708081700.js"></script>

<!-- 延迟加载公用js、css -->
<script type="text/javascript">
    var common_js = '/2324/index/common_201707271400.js';
    var common_css = '/2324/index/common_201708081700.css';
   
</script>
<script type="text/javascript" src="/2324/index/index_201708021832.js"></script>
<script>
