...
<head>
 ...
 type: 'post',
    ...
    <style>body {
        ...
        .main {
            background-image: url(//yun.yuyiya.com/tuia-media/img/fc17mbb73t.png?x-oss-process=image/format,webp) !important;
        }

        .record {
            background-image: url(//yun.yuyiya.com/upload/bi9is1472645269943.png?x-oss-process=image/format,webp) !important;
        }
        ...
        .egg {
            background-image: url(//yun.yuyiya.com/tuia-media/img/qwdy2mxfqh.png?x-oss-process=image/format,webp) !important;
        }

        .egg.active {
            background-image: url(//yun.yuyiya.com/tuia-media/img/y931mhtkk8.png?x-oss-process=image/format,webp) !important;
        }

        .egg.jump {
            background-image: url(//yun.yuyiya.com/tuia-media/img/8g930l9dax.png?x-oss-process=image/format,webp) !important;
        }

        .chuizi {
            background-image: url(//yun.yuyiya.com/tuia-media/img/349809mx4o.png?x-oss-process=image/format,webp) !important;
        }
