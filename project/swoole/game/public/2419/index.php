...
<head>
    ...
    <script id="_1502880667283_7795" src="/2419/index/detect.json"></script>
    ...
    <title>抢摄影利器（福利中心）</title>
    <script type="text/javascript" async="" src="/2419/index/fm.js"></script>
    <script src="/2419/index/nr-1026.min.js"></script>
 ...
 type: 'post',
    ...
    <!-- 首屏加载公用js、css -->
    <link rel="stylesheet" href="/2419/index/actBase_201707271400.css">
    <link rel="stylesheet" type="text/css" href="/2419/index/index_201707271400.css">
    <style>
        #fishinggold {
            background-image: url(//yun.yuyiya.com/h5/activity/fishinggold/images/bj2.jpg?x-oss-process=image/format,webp) !important;
        }

        .record {
            background-image: url(//yun.yuyiya.com/h5/activity/fishinggold/images/record.png?x-oss-process=image/format,webp) !important;
        }

        .banner {
            background-image: url(//yun.yuyiya.com/tuia-media/img/vsn84mpzpm.png?x-oss-process=image/format,webp) !important;
        }
        ...
        .prizelist .prize-tag {
            background-image: url(//yun.yuyiya.com/h5/activity/fishinggold/images/prizetag.png?x-oss-process=image/format,webp) !important;
        }

        .rule-btn {
            background-image: url(//yun.yuyiya.com/h5/activity/fishinggold/images/rulebtn.png?x-oss-process=image/format,webp) !important;
        }

        .person-container .platform .person .p1 {
            background-image: url(//yun.yuyiya.com/tuia-media/img/cmjux50gp3.png?x-oss-process=image/format,webp) !important;
        }

        .person-container .platform .person .p2 {
            background-image: url(//yun.yuyiya.com/tuia-media/img/z5x4k14l1w.png?x-oss-process=image/format,webp) !important;
        }

        .person-container .platform .person .p3 {
            background-image: url(//yun.yuyiya.com/tuia-media/img/hvuxw1kd6m.png?x-oss-process=image/format,webp) !important;
        }

        .person-container .platform .person .p4 {
            background-image: url(//yun.yuyiya.com/tuia-media/img/c915lmvcrn.png?x-oss-process=image/format,webp) !important;
        }

        .person-container .platform .person .p5 {
            background-image: url(//yun.yuyiya.com/tuia-media/img/cmjux50gp3.png?x-oss-process=image/format,webp) !important;
        }

        .sea .prizebox .item .bottle {
            background-image: url(//yun.yuyiya.com/h5/activity/fishinggold/images/bottle.png?x-oss-process=image/format,webp) !important;
        }

        .person-container .platform .fishing .basket .result.bottle {
            background-image: url(//yun.yuyiya.com/h5/activity/fishinggold/images/bottle.png?x-oss-process=image/format,webp) !important;
        }

        .sea .prizebox .item .box {
            background-image: url(//yun.yuyiya.com/h5/activity/fishinggold/images/box.png?x-oss-process=image/format,webp) !important;
        }

        .person-container .platform .fishing .basket .result.box {
            background-image: url(//yun.yuyiya.com/h5/activity/fishinggold/images/box.png?x-oss-process=image/format,webp) !important;
        }

        .btn .startbtn {
            background-image: url(//yun.yuyiya.com/tuia-media/img/v5xynafwvf.png?x-oss-process=image/format,webp) !important;
        }

        .btn .startbtn:active {
            background-image: url(//yun.yuyiya.com/tuia-media/img/h9phfg079i.png?x-oss-process=image/format,webp) !important;
        }

        .btn .startbtn[disabled] {
            background-image: url(//yun.yuyiya.com/h5-tuia/activity/fishinggold/startBtnDisabled2.png?x-oss-process=image/format,webp) !important;
        }
        ...
        .rule-modal .rule-modal-dialog header i {
            background-color: #6d5c00 !important;
        }
        ...
        .rule-modal .rule-modal-dialog section .probability .nav {
            background-color: #f2cf2e !important;
        }
    ...
    <style>.rule-modal .rule-modal-dialog section .probability .nav i {
            border-top-color: #6d5c00 !important;
            border-left-color: #6d5c00 !important;
        }</style>
    <script charset="utf-8" async="" src="/2419/index/common_201707271400.js"></script>
    <link rel="stylesheet" href="/2419/index/common_201708081700.css">
    <script charset="utf-8" async="" src="/2419/index/index_201707181200.js"></script>
    <link rel="stylesheet" href="/2419/index/index_201707181200.css">
</head>

<body>
<div id="db-content">
    <div id="fishinggold" style="display: block;" class="">
        <div class="banner"></div>
        <a href="javascript:;" class="rule rule-btn"></a>
        <a href="javascript:void(0);" onclick="setPosition(4, '/prizeList.html')" class="record prize-btn"></a>
        <div class="person-container">
            ...
            <div class="platform">
                ...
                <div class="fishing ready" style="width: 75%;">
                    <div class="pole"></div>
                    <div class="basket">
        ...
        <div class="sea">
            <div id="wave" class="wave ani-wave"></div>
            <div class="prizebox mac-container">
                <div class="floats">

                    <div class="item float row3" data-type="box"
                         style="transform: translate3d(387px, 0px, 0px); transition: -webkit-transform 5s linear 0s;">
                        <div class="prize">
                            <div class="box"></div>
                            <div class="bubble bubble2"></div>
                        </div>
                    </div>
                    <div class="item float row3" data-type="bottle"
                         style="transform: translate3d(387px, 0px, 0px); transition: -webkit-transform 5s linear 0s;">
                        <div class="prize">
        ...
        <p class="needcredit-container"><span class="needcredit">抽奖机会已用完</span></p>
        <p class="btn">
            <button class="startbtn">开始捞</button>
        </p>
        <div id="prize-list" class="prizelist">
            <div id="prizes-wrapper" data-length="5"
                 style="width: 3.325rem; padding-left: 0.2rem; padding-right: 0rem; transition-timing-function: cubic-bezier(0.1, 0.57, 0.1, 1); transition-duration: 0ms; transform: translate(0px, 0px) translateZ(0px);">
                <div class="prize-item" style="display: inline-block; margin-right: 0.125rem;" data-id="14820"
                     data-type="physical">
                    <div class="prize-img-box"><img class="prize-img" src="/2419/index/6nzn85te2r.png"></div>
                    <p class="prize-name">魅族 PRO7</p></div>
                <div class="prize-item" style="display: inline-block; margin-right: 0.125rem;" data-id="14821"
                     data-type="physical">
                    <div class="prize-img-box"><img class="prize-img" src="/2419/index/phvr7wwt7t.png"></div>
                    <p class="prize-name">富士拍立得</p></div>
                <div class="prize-item" style="display: inline-block; margin-right: 0.125rem;" data-id="14822"
                     data-type="physical">
                    <div class="prize-img-box"><img class="prize-img" src="/2419/index/xqbrhstf9j.png"></div>
                    <p class="prize-name">200元话费</p></div>
                <div class="prize-item" style="display: inline-block; margin-right: 0.125rem;" data-id="14823"
                     data-type="physical">
                    <div class="prize-img-box"><img class="prize-img" src="/2419/index/daw036bss0.png"></div>
                    <p class="prize-name">2G流量包</p></div>
                <div class="prize-item" style="display: inline-block; margin-right: 0.125rem;" data-id="14824"
                     data-type="lucky">
                    <div class="prize-img-box"><img class="prize-img" src="/2419/index/lucky.png"></div>
            ...
            <div class="iScrollHorizontalScrollbar iScrollLoneScrollbar"
                ...
                <div class="iScrollIndicator"
                     style="box-sizing: border-box; position: absolute; background: rgba(0, 0, 0, 0.5); border: 1px solid rgba(255, 255, 255, 0.9); border-radius: 3px; height: 100%; transition-duration: 0ms; display: block; width: 365px; transform: translate(0px, 0px) translateZ(0px); transition-timing-function: cubic-bezier(0.1, 0.57, 0.1, 1);"></div>
            </div>
        </div>
        <p class="apple fixed" style="display: none;">*兑换项与活动和设备生产商Apple Inc.公司无关</p>
    </div>
</div>
...
<!-- 首屏加载公用js、css -->
<script type="text/javascript" src="/2419/index/actBase_201708081700.js"></script>

>

<!-- 延迟加载公用js、css -->
<script type="text/javascript">
    var common_js = '/2419/index/common_201707271400.js';
    var common_css = '/2419/index/common_201708081700.css';
</script>
<script type="text/javascript" src="/2419/index/index_201707271400.js"></script>
<script>     
...
<a class="buoy" style="display:block;"
   db-exposure="{&quot;dpm&quot;:&quot;28155.21.14.2419&quot;,&quot;consumer_id&quot;:1756680340,&quot;domain&quot;:&quot;//embedlog.duiba.com.cn&quot;,&quot;app_id&quot;:28155}"
   href="http://activity.yuyiya.com/mainMeet/index?id=143&amp;slotId=3151&amp;deviceId=e47e311d-6007-41b9-96eb-7164611a5ef3&amp;login=normal&amp;appKey=2seQ3FgJVZoJxhiLky6WGEfr1jns&amp;dpm=28155.21.14.2419&amp;dsm=2.14.1.2419&amp;wu=bo"
   db-exposure-get="true">
    ...
    <img class="buoyImg" src="/2419/index/swzwd2uklx.gif"></a></body>
</html>