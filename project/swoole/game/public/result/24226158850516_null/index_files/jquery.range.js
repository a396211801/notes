...
var ddzfSlider = function(element, params) {
    var $main = $(element);
    var options = params ||{};
    this.init = function() {
        var context = this;
    ...
    this.sildeHander=function(){
        var context = this;
       this.jRange = $main.find(".single-slider").jRange({
            from: options.from ||  0,
            to: options.to ||100 ,
            step: options.step || 1,
            // scale: ,
           ...
           onstatechange:function(e){
               $main.find(".JS-value").html($main.find(".text-field").val());
            }
          });
    }
    this.getValue=function(){
        return $main.find(".text-field").val();
    }
};
