...
!function t(e, n, o) {
    ...
    7: [function (t, e, n) {
        !function () {
            ...
            var n = !0, o = 1;
            loadingStatus = !1;
            var a = [], r = "/ts/activity/getRecordList", s = "/ts/activity/result", l = {
                loaded: function (t) {
                    ...
                    if (!loadingStatus) {
                        ...
                        n ? ($(".loading-img").show(), $(".loading-tip").html("正在加载中"), o++, l.getMoreItems()) : ($(".loading-img").hide(), $(".loading-tip").html('已经没有更多了！<a href="/put/prize/list" class="overdue">查看已过期的奖品></a>'))
                    }
                }, events: function () {
                    var t = this;
                    $("body").on("click", ".item", function () {
                        ...
                        switch (e) {
                            case"pending":
                                window.location.href = "/ts/activity/indexRecord?vmName=pending&orderId=" + n;
                                break;
                            case"error":
                            ...
                            case"wait":
                                ...
                                break;
                            default:
                                window.location.href = "/ts/activity/indexRecord?vmName=detail&orderId=" + n
                        }
                    ...
                    c({url: r}, {currentPage: o, random: this_random}, function (e) {
                        if (e.success) {
                            ...
                            if (n = !!r.totalCount && Math.ceil(r.totalCount / 50) != o, d(l, $("#obj-item").html(), $(".obj-list")), t.loaded(n), a.length < 7 || 0 == s.length)if (console.log(s), 0 === $(".loading").length) {
                                var c = '<div class="loading"><span class="loading-tip">已经没有更多了！<a href="/put/prize/list/" class="overdue">查看已过期的奖品></a></span></div>';
                                $("body").append(c)
                            } else 0 === $(".overdue").length && $(".loading-tip").html('已经没有更多了！<a href="/put/prize/list/" class="overdue">查看已过期的奖品></a>');
