...
!function t(i, e, o) {
    ...
    1: [function (t, i, e) {
        $.cookie = function (t, i, e) {
            if ("undefined" == typeof i) {
                var o = null;
                if (document.cookie && "" != document.cookie)for (var s = document.cookie.split(";"), n = 0; n < s.length; n++) {
                    var r = $.trim(s[n]);
            ...
            var c = e.path ? "; path=" + e.path : "", h = e.domain ? "; domain=" + e.domain : "", d = e.secure ? "; secure" : "";
            document.cookie = [t, "=", encodeURIComponent(i), a, c, h, d].join("")
        }
    }, {}],
    2: [function (t, i, e) {
        !function (i) {
            var e = t("../../unit/lib/lib-template/0.0.0/artTemplate"), o = {
                init: function (e) {
                    var o = this, s = t("./tpl");
                    CFG.isShowRecommend ? this.ajax(function (t) {
                            o.render(i("#db-content"), t, s), i("#recommend-modal").show(), window.DB && window.DB.exposure && window.DB.exposure.initLog(), e && e()
                        }) : (o.render(i("#db-content"), {}, s), i("#recommend-modal").show())
                }, render: function s(t, i, o) {
                    var s = e.compile(o), n = s(i);
                    t.append(n)
                }, ajax: function (t) {
                    var e = this;
                    i.ajax({
                    ...
                    var i = "[\\?&]" + t + "=([^&#]*)", e = new RegExp(i), o = e.exec(location.href);
                    return null === o ? "" : o[1]
                }
            };
            window.recommendModal = o
        }(Zepto)
    }, {"../../unit/lib/lib-template/0.0.0/artTemplate": 19, "./tpl": 3}],
    3: [function (t, i, e) {
        i.exports = '<div id="recommend-modal" class="recommend-modal"><div class="recommend-modal-dialog"> <i class="icon close" db-exposure="{{stRecommendInfo}}" db-disabled-web=true></i><i class="icon points"></i><div class="recommend-header"></div><div class="recommend-body">{{if !block1}}<img class="recommend-over1" src="//yun.tuia.cn/h5-tuia/recommend/over1.png">{{else}}<img class="recommend-over2" src="//yun.tuia.cn/h5-tuia/recommend/over2.png"><a class="recommend-list" href="{{block1.actUrl}}"><img src="{{block1.bannerUrl}}"><div class="recommend-title">{{block1.title}}</div><div class="recommend-attend">立即参加 &gt;</div></a>{{if block2}}<a class="recommend-list" href="{{block2.actUrl}}"><img src="{{block2.bannerUrl}}"><div class="recommend-title">{{block2.title}}</div><div class="recommend-attend">立即参加 &gt;</div></a>{{/if}}{{/if}}</div></div></div>'
    }, {}],
    4: [function (t, i, e) {
        !function (t) {
            var i = function (t) {
                ...
                if ("object" === ("undefined" == typeof e ? "undefined" : o(e))) {
                    ...
                    if (e.result && e.result.lottery) {
                        ...
                        switch (s = {
                            ...
                            case 1:
                                n.tpl1 = t("./dinge/tpl1").init, n.tpl2 = t("./dinge/tpl2").init;
                                break;
                            case 2:
                                n.tpl1 = t("./random/tpl1").init, n.tpl2 = t("./random/tpl2").init;
                                break;
                            default:
                                n.tpl1 = t("./random/tpl1").init, n.tpl2 = t("./random/tpl2").init
                        }
                        n.tplResult = t("./tplResult").init, n.result = e.result, n.callback = e.callback
                    }
                    this.prize = e.prize || {}, this.prize = i.extend(!0, s, this.prize), i("body").append(n.tpl1(n.prize)).append(n.tpl2(n.prize)), e.showPage2 && (i(".modal-container1").hide(), i(".modal-container2").show()), n.exposure(), n.events()
                } else console.warn("参数错误")
            };
            s.prototype.events = function () {
                var t = this;
                t.hasClick = !1;
                var e = i(".modal-container1"), o = i(".modal-container2");
                e.on("click", ".modal-body, .modal-btn", function () {
                    e.hide(), o.show(), t.exposure()
                }), o.on("click", ".modal-btn", function () {
                    t.check(), t.status && !t.hasClick && (t.hasClick = !0, t.accountApi(function (e) {
                        switch (t.hasClick = !1, e.data.result) {
                            case"TA-0000000":
                            case"TA-0200001":
                            case"TA-0200002":
                            case"TA-0200003":
                                t.dbClickBtn(), o.hide(), i("body").append(t.tplResult(t.prize, e.data)), t.getRecommend(), setTimeout(function () {
                                    t.exposure()
                                }, 500);
                                break;
                            case"TA-0200004":
                    ...
                    e.remove(), o.remove(), i(".modal-result").remove();
                    var s = t.callback;
                    s && s.close && s.close()
                ...
                t ? i(".modal-container2").find(".modal-tip").text(t).show() : i(".modal-container2").find(".modal-tip").show()
            }, s.prototype.hideTip = function () {
                i(".modal-container2").find(".modal-tip").hide()
            }, s.prototype.check = function () {
                var t = this, e = new RegExp("^[a-z0-9]+([._\\-]*[a-z0-9])*@([a-z0-9]+[-a-z0-9]*[a-z0-9]+.){1,63}[a-z0-9]+$"), o = new RegExp("^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\\d{8})$"), s = new RegExp("^[一-龥]{2,4}$"), n = i(".modal-account")[0], r = i(".modal-name")[0];
                return e.test(n.value) || o.test(n.value) ? s.test(r.value) ? void(t.status = !0) : (t.showTip("请输入有效的姓名"), void(t.status = !1)) : (t.showTip("请输入有效的账号"), void(t.status = !1))
            }, s.prototype.dbClickBtn = function (t) {
                var i = JSON.parse(this.prize.page2.st_info_dpm_btn_get);
                i.domain4Web && this.sendApi({domain: i.domain4Web, url: i.url, data: i}, function () {
                    t && t()
                })
                ...
                i.ajax({
                    ...
                    success: function (t) {
                        t.success && (t.data.block1 ? (i(".block1").attr("href", t.data.block1.actUrl), i(".block1").find(".recommend-img").attr("src", t.data.block1.bannerUrl), t.data.block2 ? (i(".block2").attr("href", t.data.block2.actUrl), i(".block2").find(".recommend-img").attr("src", t.data.block2.bannerUrl)) : i(".block2").hide()) : i(".block1, block2").hide())
                    },
                    error: function () {
                        console.log("get recommend queue error")
                    }
    ...
    }, {"./dinge/tpl1": 4, "./dinge/tpl2": 5, "./random/tpl1": 7, "./random/tpl2": 8, "./tplResult": 9}],
    7: [function (t, i, e) {
        !function (t) {
            var i = function (t) {
    ...
    10: [function (t, i, e) {
        !function (i) {
            ...
            if (o) {
                _fmOpt = {partner: "duiba", appName: "tuia_h5", token: o};
                var s = new Image(1, 1);
                s.onload = function () {
                    _fmOpt.imgLoaded = !0
    ...
    11: [function (t, i, e) {
        t("../../../../unit/common/js/downloadApp"), t("../../../../unit/common/js/statistics"), t("../../../../unit/common/js/showObjectPrize"), t("../../../../unit/common/js/showModal"), t("../../../../unit/common/js/prizeDetail"), t("../../../../module/tongdun"), t("../../../../module/showAlipayPrize/index"), t("../../../../module/recommendModal"), t("./../components/intercept")
    }, {
    ...
    12: [function (t, i, e) {
        !function () {
            ...
            function e(t) {
                $.ajax({
                    url: "/ts/activity/updateReturnTimes",
                    type: "post",
    ...
    13: [function (t, i, e) {
        ...
        !function (t, i, e) {
            ...
            function n(t, e, o) {
                var s = i.createElement("div"), n = i.createElement("div");
                return o === !0 && (s.style.cssText = "position:absolute;z-index:9999", n.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.9);border-radius:3px"), n.className = "iScrollIndicator", "h" == t ? (o === !0 && (s.style.cssText += ";height:7px;left:2px;right:2px;bottom:0", n.style.height = "100%"), s.className = "iScrollHorizontalScrollbar") : (o === !0 && (s.style.cssText += ";width:7px;bottom:2px;top:2px;right:1px", n.style.width = "100%"), s.className = "iScrollVerticalScrollbar"), s.style.cssText += ";overflow:hidden", e || (s.style.pointerEvents = "none"), s.appendChild(n), s
            }

            function r(e, o) {
                this.wrapper = "string" == typeof o.el ? i.querySelector(o.el) : o.el, this.wrapperStyle = this.wrapper.style, this.indicator = this.wrapper.children[0], this.indicatorStyle = this.indicator.style, this.scroller = e, this.options = {
                    listenX: !0,
                    listenY: !0,
                    interactive: !1,
                    resize: !0,
            ...
            var a = t.requestAnimationFrame || t.webkitRequestAnimationFrame || t.mozRequestAnimationFrame || t.oRequestAnimationFrame || t.msRequestAnimationFrame || function (i) {
                ...
                var n = {}, r = i.createElement("div").style, a = function () {
                    for (var t, i = ["t", "webkitT", "MozT", "msT", "OT"], e = 0, o = i.length; e < o; e++)if (t = i[e] + "ransform", t in r)return i[e].substr(0, i[e].length - 1);
                    return !1
                }();
                n.getTime = Date.now || function () {
                    ...
                    return r = void 0 === r ? 6e-4 : r, a = t + h * h / (2 * r) * (c < 0 ? -1 : 1), l = h / r, a < s ? (a = n ? s - n / 2.5 * (h / 8) : s, c = e.abs(a - t), l = c / h) : a > 0 && (a = n ? n / 2.5 * (h / 8) : 0, c = e.abs(t) + a, l = c / h), {
            ...
            s.prototype = {
                version: "5.2.0", _init: function () {
                    ...
                    if (this.enabled && (!this.initiated || l.eventType[t.type] === this.initiated)) {
                        ...
                        var o, s = t.touches ? t.touches[0] : t;
                    ...
                    if (this.enabled && l.eventType[t.type] === this.initiated) {
                        ...
                        var i, o, s, n, r = t.touches ? t.touches[0] : t, a = r.pageX - this.pointX, c = r.pageY - this.pointY, h = l.getTime();
                        if (this.pointX = r.pageX, this.pointY = r.pageY, this.distX += a, this.distY += c, s = e.abs(this.distX), n = e.abs(this.distY), !(h - this.endTime > 300 && s < 10 && n < 10)) {
                            ...
                            a = this.hasHorizontalScroll ? a : 0, c = this.hasVerticalScroll ? c : 0, i = this.x + a, o = this.y + c, (i > 0 || i < this.maxScrollX) && (i = this.options.bounce ? this.x + a / 3 : i > 0 ? 0 : this.maxScrollX), (o > 0 || o < this.maxScrollY) && (o = this.options.bounce ? this.y + c / 3 : o > 0 ? 0 : this.maxScrollY), this.directionX = a > 0 ? -1 : a < 0 ? 1 : 0, this.directionY = c > 0 ? -1 : c < 0 ? 1 : 0, this.moved || this._execEvent("scrollStart"), this.moved = !0, this._translate(i, o), h - this.startTime > 300 && (this.startTime = h, this.startX = this.x, this.startY = this.y)
                        }
                    }
                }, _end: function (t) {
                    if (this.enabled && l.eventType[t.type] === this.initiated) {
                        this.options.preventDefault && !l.preventDefaultException(t.target, this.options.preventDefaultException) && t.preventDefault();
                        var i, o, s = (t.changedTouches ? t.changedTouches[0] : t, l.getTime() - this.startTime), n = e.round(this.x), r = e.round(this.y), a = e.abs(n - this.startX), c = e.abs(r - this.startY), h = 0, d = "";
                        if (this.isInTransition = 0, this.initiated = 0, this.endTime = l.getTime(), !this.resetPosition(this.options.bounceTime)) {
                            ...
                            if (this._events.flick && s < 200 && a < 100 && c < 100)return void this._execEvent("flick");
                            if (this.options.momentum && s < 300 && (i = this.hasHorizontalScroll ? l.momentum(this.x, this.startX, s, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options.deceleration) : {
                                        destination: n,
                                        duration: 0
                                    }, o = this.hasVerticalScroll ? l.momentum(this.y, this.startY, s, this.maxScrollY, this.options.bounce ? this.wrapperHeight : 0, this.options.deceleration) : {
                                        destination: r,
                                        duration: 0
                                ...
                                this.currentPage = p, h = this.options.snapSpeed || e.max(e.max(e.min(e.abs(n - p.x), 1e3), e.min(e.abs(r - p.y), 1e3)), 300), n = p.x, r = p.y, this.directionX = 0, this.directionY = 0, d = this.options.bounceEasing
                            }
                            return n != this.x || r != this.y ? ((n > 0 || n < this.maxScrollX || r > 0 || r < this.maxScrollY) && (d = l.ease.quadratic), void this.scrollTo(n, r, h, d)) : void this._execEvent("scrollEnd")
                        }
                    }
                }, _resize: function () {
                    var t = this;
                    ...
                    if (this.options.useTransform ? this.scrollerStyle[l.style.transform] = "translate(" + t + "px," + i + "px)" + this.translateZ : (t = e.round(t), i = e.round(i), this.scrollerStyle.left = t + "px", this.scrollerStyle.top = i + "px"), this.x = t, this.y = i, this.indicators)for (var o = this.indicators.length; o--;)this.indicators[o].updatePosition()
                }, _initEvents: function (i) {
                    var e = i ? l.removeEvent : l.addEvent, o = this.options.bindToWrapper ? this.wrapper : t;
                    e(t, "orientationchange", this), e(t, "resize", this), this.options.click && e(this.wrapper, "click", this, !0), this.options.disableMouse || (e(this.wrapper, "mousedown", this), e(o, "mousemove", this), e(o, "mousecancel", this), e(o, "mouseup", this)), l.hasPointer && !this.options.disablePointer && (e(this.wrapper, l.prefixPointerEvent("pointerdown"), this), e(o, l.prefixPointerEvent("pointermove"), this), e(o, l.prefixPointerEvent("pointercancel"), this), e(o, l.prefixPointerEvent("pointerup"), this)), l.hasTouch && !this.options.disableTouch && (e(this.wrapper, "touchstart", this), e(o, "touchmove", this), e(o, "touchcancel", this), e(o, "touchend", this)), e(this.scroller, "transitionend", this), e(this.scroller, "webkitTransitionEnd", this), e(this.scroller, "oTransitionEnd", this), e(this.scroller, "MSTransitionEnd", this);
                }, getComputedPosition: function () {
                    var i, e, o = t.getComputedStyle(this.scroller, null);
                    return this.options.useTransform ? (o = o[l.style.transform].split(")")[0].split(", "), i = +(o[12] || o[4]), e = +(o[13] || o[5])) : (i = +o.left.replace(/[^-\d.]/g, ""), e = +o.top.replace(/[^-\d.]/g, "")), {
                        x: i,
                        y: e
                    }
                    ...
                    var i, e = this.options.interactiveScrollbars, o = "string" != typeof this.options.scrollbars, s = [], a = this;
                    this.indicators = [], this.options.scrollbars && (this.options.scrollY && (i = {
                        ...
                        fade: this.options.fadeScrollbars,
                        listenY: !1
                    }, this.wrapper.appendChild(i.el), s.push(i))), this.options.indicators && (s = s.concat(this.options.indicators));
                    ...
                    if (this.enabled) {
                        ...
                        if (void 0 === this.wheelTimeout && r._execEvent("scrollStart"), clearTimeout(this.wheelTimeout), this.wheelTimeout = setTimeout(function () {
                            ...
                            }, 400), "deltaX" in t) 1 === t.deltaMode ? (i = -t.deltaX * this.options.mouseWheelSpeed, o = -t.deltaY * this.options.mouseWheelSpeed) : (i = -t.deltaX, o = -t.deltaY); else if ("wheelDeltaX" in t) i = t.wheelDeltaX / 120 * this.options.mouseWheelSpeed, o = t.wheelDeltaY / 120 * this.options.mouseWheelSpeed; else if ("wheelDelta" in t) i = o = t.wheelDelta / 120 * this.options.mouseWheelSpeed; else {
                            if (!("detail" in t))return;
                            i = o = -t.detail / 3 * this.options.mouseWheelSpeed
                        }
                        if (i *= this.options.invertWheelDirection, o *= this.options.invertWheelDirection, this.hasVerticalScroll || (i = o, o = 0), this.options.snap)return s = this.currentPage.pageX, n = this.currentPage.pageY, i > 0 ? s-- : i < 0 && s++, o > 0 ? n-- : o < 0 && n++, void this.goToPage(s, n);
                        s = this.x + e.round(this.hasHorizontalScroll ? i : 0), n = this.y + e.round(this.hasVerticalScroll ? o : 0), this.directionX = i > 0 ? -1 : i < 0 ? 1 : 0, this.directionY = o > 0 ? -1 : o < 0 ? 1 : 0, s > 0 ? s = 0 : s < this.maxScrollX && (s = this.maxScrollX), n > 0 ? n = 0 : n < this.maxScrollY && (n = this.maxScrollY), this.scrollTo(s, n, 0)
                    }
                }, _initSnap: function () {
                    this.currentPage = {}, "string" == typeof this.options.snap && (this.options.snap = this.scroller.querySelectorAll(this.options.snap)), this.on("refresh", function () {
                        var t, i, o, s, n, r, a = 0, l = 0, c = 0, h = this.options.snapStepX || this.wrapperWidth, d = this.options.snapStepY || this.wrapperHeight;
                        if (this.pages = [], this.wrapperWidth && this.wrapperHeight && this.scrollerWidth && this.scrollerHeight) {
                            if (this.options.snap === !0)for (o = e.round(h / 2), s = e.round(d / 2); c > -this.scrollerWidth;) {
                                ...
                                c -= h, a++
                            } else for (r = this.options.snap, t = r.length, i = -1; a < t; a++)(0 === a || r[a].offsetLeft <= r[a - 1].offsetLeft) && (l = 0, i++), this.pages[l] || (this.pages[l] = []), c = e.max(-r[a].offsetLeft, this.maxScrollX), n = e.max(-r[a].offsetTop, this.maxScrollY), o = c - e.round(r[a].offsetWidth / 2), s = n - e.round(r[a].offsetHeight / 2), this.pages[l][i] = {
                                x: c,
                                y: n,
                    ...
                    for (t > 0 ? t = 0 : t < this.maxScrollX && (t = this.maxScrollX), i > 0 ? i = 0 : i < this.maxScrollY && (i = this.maxScrollY); o < s; o++)if (t >= this.pages[o][0].cx) {
                        t = this.pages[o][0].x;
                        break
                    }
                    for (s = this.pages[o].length; n < s; n++)if (i >= this.pages[0][n].cy) {
                        i = this.pages[0][n].y;
                        break
                    }
                    return o == this.currentPage.pageX && (o += this.directionX, o < 0 ? o = 0 : o >= this.pages.length && (o = this.pages.length - 1), t = this.pages[o][0].x), n == this.currentPage.pageY && (n += this.directionY, n < 0 ? n = 0 : n >= this.pages[0].length && (n = this.pages[0].length - 1), i = this.pages[0][n].y), {
                        x: t,
                        y: i,
                        pageX: o,
                        pageY: n
                    ...
                    s = s || this.options.bounceEasing, t >= this.pages.length ? t = this.pages.length - 1 : t < 0 && (t = 0), i >= this.pages[t].length ? i = this.pages[t].length - 1 : i < 0 && (i = 0);
                    var n = this.pages[t][i].x, r = this.pages[t][i].y;
                    o = void 0 === o ? this.options.snapSpeed || e.max(e.max(e.min(e.abs(n - this.x), 1e3), e.min(e.abs(r - this.y), 1e3)), 300) : o, this.currentPage = {
                        x: n,
                        y: r,
                        pageX: t,
                        pageY: i
                    ...
                    e++, e >= this.pages.length && this.hasVerticalScroll && (e = 0, o++), this.goToPage(e, o, t, i)
                }, prev: function (t, i) {
                    var e = this.currentPage.pageX, o = this.currentPage.pageY;
                    e--, e < 0 && this.hasVerticalScroll && (e = 0, o--), this.goToPage(e, o, t, i)
                }, _initKeys: function (i) {
                    var e, s = {pageUp: 33, pageDown: 34, end: 35, home: 36, left: 37, up: 38, right: 39, down: 40};
                    if ("object" == o(this.options.keyBindings))for (e in this.options.keyBindings)"string" == typeof this.options.keyBindings[e] && (this.options.keyBindings[e] = this.options.keyBindings[e].toUpperCase().charCodeAt(0)); else this.options.keyBindings = {};
                    ...
                    if (this.enabled) {
                        var i, o = this.options.snap, s = o ? this.currentPage.pageX : this.x, n = o ? this.currentPage.pageY : this.y, r = l.getTime(), a = this.keyTime || 0, c = .25;
                        switch (this.options.useTransition && this.isInTransition && (i = this.getComputedPosition(), this._translate(e.round(i.x), e.round(i.y)), this.isInTransition = !1), this.keyAcceleration = r - a < 200 ? e.min(this.keyAcceleration + c, 50) : 0, t.keyCode) {
                    ...
                    function s() {
                        ...
                        return m >= d ? (n.isAnimating = !1, n._translate(t, i), void(n.resetPosition(n.options.bounceTime) || n._execEvent("scrollEnd"))) : (m = (m - h) / e, f = o(m), p = (t - r) * f + r, u = (i - c) * f + c, n._translate(p, u), void(n.isAnimating && a(s)))
                    }

                    var n = this, r = this.x, c = this.y, h = l.getTime(), d = h + e;
                ...
                handleEvent: function (t) {
                    ...
                    var i, e, o, s, n = t.touches ? t.touches[0] : t;
                    l.getTime();
                    this.moved || this.scroller._execEvent("scrollStart"), this.moved = !0, i = n.pageX - this.lastPointX, this.lastPointX = n.pageX, e = n.pageY - this.lastPointY, this.lastPointY = n.pageY, o = this.x + i, s = this.y + e, this._pos(o, s), t.preventDefault(), t.stopPropagation()
                }, _end: function (i) {
                    if (this.initiated) {
                        if (this.initiated = !1, i.preventDefault(), i.stopPropagation(), l.removeEvent(t, "touchmove", this), l.removeEvent(t, l.prefixPointerEvent("pointermove"), this), l.removeEvent(t, "mousemove", this), this.scroller.options.snap) {
                            var o = this.scroller._nearestSnap(this.scroller.x, this.scroller.y), s = this.options.snapSpeed || e.max(e.max(e.min(e.abs(this.scroller.x - o.x), 1e3), e.min(e.abs(this.scroller.y - o.y), 1e3)), 300);
            ...
            }, s.utils = l, t.IScroll = s
        }(window, document, Math)
    }, {}],
    14: [function (t, i, e) {
        !function (t) {
            var i = navigator.userAgent.toLowerCase(), e = function () {
                window.downloadAppConfig ? i.match(/iphone/gi) || i.match(/ipad/gi) ? s() : window.downloadAppConfig.confirm || "true" == window.downloadAppConfig.confirm ? t.modal({
                                type: "confirm",
                                title: "下载确认",
                                section: "即将开始下载，是否继续",
                                callback: {
                            ...
                            }) : s() : console.error("请先配置参数window.downloadAppConfig")
            }, o = function (t) {
                ...
                var t, e = window.downloadAppConfig.openUrl || "", s = "", n = !1;
                ...
                if (i.match(/iphone/gi) || i.match(/ipad/gi)) {
                    if (s = window.downloadAppConfig.iosDownloadUrl, r(s), n)return;
                    if (i.match(/MicroMessenger/gi)) o(s); else if (e) window.location.href = e; else if (s.indexOf("itunes.apple.com") != -1) {
                        var a = document.createElement("iframe");
                        a.src = s, a.style.display = "none", window.setTimeout(function () {
                            document.body.appendChild(a)
                        }, 300)
                    } else o(s)
                } else {
                    if (s = window.downloadAppConfig.androidDownloadUrl, r(s), n)return;
                    if (e)return void(window.location.href = e);
                    s.indexOf(".apk") != -1 || s.indexOf("dbnewopen") != -1 ? window.location.href = s : o(s)
                }
            };
        ...
        !function (t) {
            var i = {
                show: function (i) {
                    ...
                    }, n = s[i.type], r = '<div class="db-msg-modal"><div class="msg-modal-wrapper"><div class="msg-modal-header"><i class="msg-modal-close"></i><h4 class="msg-title">' + i.title + '</h4><p class="msg-tip">' + i.tip + '</p></div><div class="msg-modal-section">' + (n ? '<img src="' + n + '" />' : "") + '</div><div class="msg-modal-footer"><a href="javascript:;" class="msg-btn">' + i.btnText + "</a></div></div></div>";
                    t("body").append(r), t("#db-content").addClass("filter"), t(".db-msg-modal").off("click").on("click", ".msg-modal-close", function () {
                        i.clickCallback && i.clickCallback(), o.hide()
                    }).on("click", ".msg-btn", function () {
                        i.link && (window.location.href = i.link), i.btnCallback ? i.btnCallback() : i.clickCallback && i.clickCallback(), o.hide()
                    })
                }
            };
    ...
    17: [function (t, i, e) {
        !function (t) {
            var i = function (i) {
                ...
                var o = "";
                o += '<div class="prize-dialog-modal"><div class="prize-dialog-wrapper animated zoomIn"><span class="shine"></span>', o += '<div class="prize-dialog-content"><span class="trophy"></span>';
                for (var s = 3; s <= 11; s++)o += '<span class="color-point point' + s + '"></span>';
                o += '<span class="btn-close"></span>', o += "<h3>" + i.title + '</h3><p class="prize-name">' + i.name + '</p><img src="' + i.img + '" />', o += '<p class="prize-desc">' + i.desc + "</p>", o += '<div class="btns">', o += '<a href="javascript:;" class="btn btn-left btn-orange btn-cancle">' + i.leftBtnText + "</a>", o += '<a href="javascript:;" class="btn btn-right btn-red btn-submit">' + i.btnText + "</a>", o += "</div></div></div></div>", t("body").append(o), t(".prize-dialog-wrapper").find(".btn-submit").on("click", i.onsubmit), t(".prize-dialog-wrapper").find(".btn-close,.btn-cancle").on("click", function () {
            ...
            var o = {
                initLog: function () {
                    ...
                    i("body").find("[db-exposure]").not("[db-exposure-get]").each(function () {
                        ...
                        if (!r.offset() || 0 !== r.offset().width) {
                            ...
                            if (r.offset() && (l = i(t).scrollTop() >= r.offset().top - n + (o || 0), c = i(t).scrollTop() <= r.offset().top + (o || 50)), l && c && (r.attr("db-exposure-get", !0), void 0 !== a && "undefined" !== a && "" !== i.trim(a))) {
                                ...
                                }), a.domain4Web && s.sendApi({domain: a.domain4Web, url: a.url, data: a}, function () {
                                    e && e(), r.attr("db-exposure-get", !0)
                                })
                            }
                        }
                    ...
                    i("body").find("[db-click]").unbind("click.statistics").bind("click.statistics", function () {
                        var o = i(this), s = o.attr("db-click");
                        if ("none" !== o.css("display") && "disabled" !== o.attr("disabled") && !o.prop("disabled") && void 0 !== s && "undefined" !== s && "" !== i.trim(s)) {
                            ...
                            s.domain4Web && e.sendApi({domain: s.domain4Web, url: s.url, data: s}, function () {
    ...
    19: [function (t, i, e) {
        ...
        !function () {
            function t(t) {
                return t.replace(S, "").replace(T, ",").replace(k, "").replace(_, "").replace(E, "").split(/^$|,+/)
            }
            ...
            function n(i, e) {
                function o(t) {
                    return p += t.split(/\n/).length - 1, h && (t = t.replace(/\s+/g, " ").replace(/<!--.*?-->/g, "")), t && (t = m[1] + s(t) + m[2] + "\n"), t
                }

                function n(i) {
                    var o = p;
                    if (c ? i = c(i, e) : r && (i = i.replace(/\n/g, function () {
                                return p++, "$line=" + p + ";"
                            })), 0 === i.indexOf("=")) {
                        var s = d && !/^=[=#]/.test(i);
                    ...
                    return r && (i = "$line=" + o + ";" + i), w(t(i), function (t) {
                        if (t && !u[t]) {
                            var i;
                            i = "print" === t ? b : "include" === t ? x : v[t] ? "$utils." + t : g[t] ? "$helpers." + t : "$data." + t, S += t + "=" + i + ",", u[t] = !0
                        }
                    }), i + "\n"
                }

                var r = e.debug, a = e.openTag, l = e.closeTag, c = e.parser, h = e.compress, d = e.escape, p = 1, u = {
                    $data: 1,
                    $filename: 1,
                    $utils: 1,
                    $helpers: 1,
                    $out: 1,
                    $line: 1
                }, f = "".trim, m = f ? ["$out='';", "$out+=", ";", "$out"] : ["$out=[];", "$out.push(", ");", "$out.join('')"], y = f ? "$out+=text;return $out;" : "$out.push(text);", b = "function(){var text=''.concat.apply('',arguments);" + y + "}", x = "function(filename,data){data=data||$data;var text=$utils.$include(filename,data,$filename);" + y + "}", S = "'use strict';var $utils=this,$helpers=$utils.$helpers," + (r ? "$line=0," : ""), T = m[0], k = "return new String(" + m[3] + ");";
                w(i.split(a), function (t) {
                    t = t.split(l);
                    var i = t[0], e = t[1];
                    1 === t.length ? T += o(i) : (T += n(i), e && (T += o(e)))
                });
                var _ = S + T + k;
                r && (_ = "try{" + _ + "}catch(e){throw {filename:$filename,name:'Render Error',message:e.message,line:$line,source:" + s(i) + ".split(/\\n/)[$line-1].replace(/^\\s+/,'')};}");
                try {
                    var E = new Function("$data", "$filename", _);
                    return E.prototype = v, E
                } catch (P) {
                    throw P.temp = "function anonymous($data,$filename) {" + _ + "}", P
                }
            }

            var r = function (t, i) {
                return "string" == typeof i ? b(i, {filename: t}) : c(t, i)
            };
            ...
            r.get = function (t) {
                var i;
                if (l[t]) i = l[t]; else if ("object" == ("undefined" == typeof document ? "undefined" : o(document))) {
            ...
            var h = function z(t, i) {
                return "string" != typeof t && (i = "undefined" == typeof t ? "undefined" : o(t), "number" === i ? t += "" : t = "function" === i ? z(t.call(t)) : ""), t
            }, d = {"<": "&#60;", ">": "&#62;", '"': "&#34;", "'": "&#39;", "&": "&#38;"}, p = function (t) {
                return d[t]
            }, u = function (t) {
                ...
                var e, o;
                if (f(t))for (e = 0, o = t.length; o > e; e++)i.call(t, t[e], e, t); else for (e in t)i.call(t, t[e], e)
            }, v = r.utils = {$helpers: {}, $include: c, $string: h, $escape: u, $each: m};
            ...
            r.onerror = function (t) {
                ...
                for (var e in t)i += "<" + e + ">\n" + t[e] + "\n\n";
                "object" == ("undefined" == typeof console ? "undefined" : o(console)) && console.error(i)
            };
            var y = function (t) {
                ...
                function e(e) {
                    try {
                        ...
                        return i.debug ? y(o)() : (i.debug = !0, b(t, i)(e))
                    }
                }
                ...
                try {
                    ...
                    return c.filename = s || "anonymous", c.name = "Syntax Error", y(c)
                }
                return e.prototype = r.prototype, e.toString = function () {
                    return r.toString()
                }, s && i.cache && (l[s] = e), e
            }, w = v.$each, x = "break,case,catch,continue,debugger,default,delete,do,else,false,finally,for,function,if,in,instanceof,new,null,return,switch,this,throw,true,try,typeof,var,void,while,with,abstract,boolean,byte,char,class,const,double,enum,export,extends,final,float,goto,implements,import,int,interface,long,native,package,private,protected,public,short,static,super,synchronized,throws,transient,volatile,arguments,let,yield,undefined", S = /\/\*[\w\W]*?\*\/|\/\/[^\n]*\n|\/\/[^\n]*$|"(?:[^"\\]|\\[\w\W])*"|'(?:[^'\\]|\\[\w\W])*'|\s*\.\s*[$\w\.]+/g, T = /[^\w$]+/g, k = new RegExp(["\\b" + x.replace(/,/g, "\\b|\\b") + "\\b"].join("|"), "g"), _ = /^\d[^,]*|,\d[^,]*/g, E = /^,+|,+$/g;
            a.openTag = "{{", a.closeTag = "}}";
            var P = function (t, i) {
                var e = i.split(":"), o = e.shift(), s = e.join(":") || "";
                return s && (s = ", " + s), "$helpers." + o + "(" + t + s + ")"
            };
            a.parser = function (t, i) {
                t = t.replace(/^\s/, "");
                var e = t.split(" "), o = e.shift(), s = e.join(" ");
                switch (o) {
                    case"if":
                        t = "if(" + s + "){";
                        break;
                    ...
                    case"/if":
                        ...
                        break;
                    case"each":
                        var n = e[0] || "$data", a = e[1] || "as", l = e[2] || "$value", c = e[3] || "$index", h = l + "," + c;
                        "as" !== a && (n = "[]"), t = "$each(" + n + ",function(" + h + "){";
                        break;
                    case"/each":
                        t = "});";
                        break;
                    ...
                    default:
                        if (-1 !== s.indexOf("|")) {
                            ...
                            for (var p = 0, u = t.split("|"), f = u.length, m = d ? "$escape" : "$string", v = m + "(" + u[p++] + ")"; f > p; p++)v = P(v, u[p]);
                            t = "=#" + v
                        } else t = r.helpers[o] ? "=#" + o + "(" + e.join(",") + ");" : "=" + t
                }
                return t
