                    ...
                    <div class="box-tools">
                        <form class="form-inline">
                            <div class="form-group input-group-sm">
                                ...
                                <input type="text" class="form-control" name="name" value="<?php echo fn_get_val('name')?>" placeholder="广告ID/广告名称">
                                <input type="hidden" name="id" value="<?php echo isset($id) ? $id : ''?>">
                                <button type="submit" class="btn btn-default btn-sm"><i class="fa fa-search"></i>搜索</button>
                                <button type="button" class="btn btn-default btn-sm update" data-table="report_advert" data-type="1">更新数据</button>
