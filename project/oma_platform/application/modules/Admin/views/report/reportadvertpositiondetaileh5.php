<div class="content">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover text-center">
                        ...
                        <tr>
                            ...
                            <td><?php echo $v['is_third'] == 1 ? '是' : '否';?></td>
                            <td><?php echo $v['pv']?></td>
                            ...
                            <td><button class="layui-btn layui-btn-normal layui-btn-xs modify-profit" data-id="<?php echo $v['id']?>">修改收益</button></td>
                        </tr>
                        <?php }} else { echo '<tr>
    ...
    <div>
        ...
        活动广告曝光量
        <span class="text-danger"><?php echo isset($list['total']['sum_tpl_ads_pv']) ? $list['total']['sum_tpl_ads_pv'] : 0?></span>
        活动广告点击量
        <span class="text-danger"><?php echo isset($list['total']['sum_tpl_ads_click']) ? $list['total']['sum_tpl_ads_click'] : 0?></span>
        实际收益
