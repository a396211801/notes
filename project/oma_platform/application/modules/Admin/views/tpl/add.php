                ...
                <form class="form-horizontal layui-form" id="form">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="" name="name" placeholder="活动名称：">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" class="form-control" name="pic" id="pic" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="radio" lay-filter="isthird" name="is_third" value="0" title="否" checked="">
                            </div>
                        </div>
                        <div class="form-group third-url" style="display: none;">
                            <label for="" class="col-sm-2 control-label">三方链接：</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="" name="third_url" placeholder="三方链接">
                            </div>
                        </div>
                        <div class="form-group third-url" style="display: none;">
                            <label for="" class="col-sm-2 control-label">活动模板标识：</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="" name="uniqe_name1" placeholder="活动模板标识">
                            </div>
                        </div>
