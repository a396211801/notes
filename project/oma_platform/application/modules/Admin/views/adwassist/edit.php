                ...
                <form class="form-horizontal layui-form" id="form">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group third-url">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="" value="<?php echo $info['show_rate']; ?>"
                                       name="show_rate" placeholder="跳转概率">
                            </div>
                        </div>
                        <div class="form-group ">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" name="shield_area" id="shield_area"
                                       value="<?php echo $info['shield_area']; ?>">
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="" class="col-sm-2 control-label">屏蔽Ip：</label>
                            <div class="col-sm-10">
                                <textarea name="shield_ip" rows="8"
                                          style="width: 50%;"><?php echo str_replace(";", "\n", $info['shield_ip']); ?></textarea>
                            </div>
                        </div>
...
<script>
    layui.use(['upload', 'form', "layer", "laytpl"], function () {
        ...
        var SList = [<?php echo str_replace(";", ",", $info['shield_area']);?>];
        var showType = "<?php echo $info['show_type']?>";
        $("[name='show_type'][value='"+showType+"']").attr("checked","checked");
        $("[name='adw_id']").val(<?php echo $info['adw_id'];?>);
        if (showType == 1) {
            $('.third-url').show();
        } else {
            $('.third-url').hide();
