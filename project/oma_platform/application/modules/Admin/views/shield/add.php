                ...
                <form class="form-horizontal layui-form" id="form">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="" name="name" placeholder="名称：">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea rows="10" style="width: 100%" name="urls"></textarea>
                            </div>
                        </div>
