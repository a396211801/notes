...
<script type="text/javascript">
    ...
    var this_awid = storage.getItem("awid");
    var this_id = storage.getItem("id");
...
<script type="text/javascript" src="/js/lpt/common_201707181200.js"></script>
<script type="text/javascript" src="/js/lpt/list_201707261909.js"></script>
<script>
...
<script type="text/template" id="obj-item">
    ...
    <a class="cf item"  data-status="${item.resStatus}" data-orderid="${item.orderId}" data-aid="${item.aid}">
...
<script>
    $(function() {
        $.ajax({
            ...
            dataType: 'json',
            type: 'post',
            data: {random: this_random, awid: this_awid, id: this_id,pos:4},
            success: function () {}
        })
    })
    ...
    $('body').on('click', '.item', function () {
        ...
        $.ajax({
            ...
            type: 'post',
            async:false,
            data: {id: this_id,  awid: this_awid, random: this_random, position: 5},
            success: function () {
            }
        })
    })
